...
class CustomerController extends Controller
{
    ...
    public function index(){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'java-master/customer',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $form = array(
                ...
                'provinsi' => $request->input('provinsi') !== '' ? $request->input('provinsi') : '-',
                'provinsi_name' => $request->input('provinsi_name') !== '' ? $request->input('provinsi_name') : '-',
                'kecamatan' => $request->input('kecamatan') !== '' ? $request->input('kecamatan') : '-',
                'kecamatan_name' => $request->input('kecamatan_name') !== '' ? $request->input('kecamatan_name') : '-',
                'kota' => $request->input('kota') !== '' ? $request->input('kota') : '-',
                'kota_name' => $request->input('kota_name') !== '' ? $request->input('kota_name') : '-',
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'java-master/customer',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getData(Request $request) {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'java-master/customer?kode_customer='.$request->query('kode'),
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
    ...
    public function update(Request $request) {
        ...
        try {   
            ...
            $client = new Client();
            $response = $client->request('PUT',  config('api.url').'java-master/customer',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function delete(Request $request) {
        try{
            $client = new Client();
            $response = $client->request('DELETE',  config('api.url').'java-master/customer?kode_customer='.$request->input('kode'),
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
