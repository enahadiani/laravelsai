...
<script type="text/javascript">
    ...
    function init(kode_klp){
        $.ajax({
            type: 'GET',
            url: "{{ url('gis-master/setting-menu') }}",
            dataType: 'json',
            ...
            success:function(result){    
                ...
                if(result.data.status){
                    ...
                    window.location.href = "{{ url('gis-auth/sesi-habis') }}";
                }
            }
        });
    }
    ...
    $(document).ready(function(){
        ...
        e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('gis-master/setting-menu-move') }}",
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
