<link href="{{ asset('asset_elite/dist/css/custom.css') }}" rel="stylesheet">
    <div class="container-fluid mt-3">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data Status Guru 
            ...
            <div class="col-sm-12" style="height: 90px;">
                <div class="card">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Form Status Guru
                    ...
                    <div class="card-body table-responsive pt-0" style='height:460px'>
                        <form class="form" id="form-tambah" style='margin-bottom:100px'>
                            ...
                            <div class="form-group row">
                                <label for="kode_status" class="col-3 col-form-label">Kode</label>
                                <div class="col-3">
                                    <input class="form-control" type="text" placeholder="Kode Status" id="kode_status" name="kode_status" required >
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    $('#kode_status,#nama,#kode_pp,#flag_aktif').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['kode_status','nama','kode_pp','flag_aktif'];
        if (code == 13 || code == 40) {
            e.preventDefault();
        ...
        var id = $('#kode_status').val();
        if(parameter == "edit"){
            var url = "{{ url('/tarbak/postStatusGuru') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/tarbak/postStatusGuru') }}";
            var pesan = "saved";
        }
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('tarbak/getStatusGuru') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
            success:function(res){
                ...
                if(result.status){
                    ...
                    $('#kode_status').val(id);
                    $('#method').val('put');
                    $('#kode_status').attr('readonly', true);
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('tarbak/deleteStatusGuru') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
