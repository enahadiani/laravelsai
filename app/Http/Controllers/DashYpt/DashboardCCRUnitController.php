...
class DashboardCCRUnitController extends Controller {
    /**
    ...
    public function getDataBox(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-ccr-unit-box',[
                'headers' => [
    ...
    public function getTrendCCR(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-ccr-unit-trend',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getTrendSaldoPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-ccr-unit-trend-saldo',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getUmurPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-ccr-unit-umur-piutang',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
