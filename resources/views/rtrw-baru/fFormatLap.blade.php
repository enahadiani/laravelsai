...
<script type="text/javascript">
    ...
    function init(kode_fs,modul){
        $.ajax({
            type: 'GET',
            url: "{{ url('rtrw-master/format-laporan') }}",
            dataType: 'json',
    ...
    function getVersi(){
        $.ajax({
            type: 'GET',
            url: "{{ url('rtrw-master/format-laporan-versi') }}",
            dataType: 'json',
            success:function(result){    
                if(result.data.status){
    ...
    function getTipe(){
        $.ajax({
            type: 'GET',
            url: "{{ url('rtrw-master/format-laporan-tipe') }}",
            dataType: 'json',
    ...
    $(document).ready(function(){
        ...
        e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('rtrw-master/format-laporan-move') }}",
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
        ...
        function getDataAkun(kode_neraca,modul){
            $.ajax({
                type: 'GET',
                url: "{{ url('rtrw-master/format-laporan-relakun') }}",
                dataType: 'json',
        ...
        $('#form-relasi').on('click','#simpanRelasi',function(e){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('rtrw-master/format-laporan-relasi') }}",
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
