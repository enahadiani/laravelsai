...
<body>
	...
	<table class='table table-bordered info-table' style='width:100%'>
        <thead>
            <tr>
                <th width='1%'  class='header_laporan' align='center'>No</th>
                <th width='4%' class='header_laporan' align='center'>Kode Akun</th>
                <th width='23%' class='header_laporan' align='center'>Nama Akun</th>
                <th width='4%' class='header_laporan' align='center'>Saldo Awal</th>
                <th width='4%' class='header_laporan' align='center'>Januari</th>
                <th width='4%' class='header_laporan' align='center'>Februari</th>
                <th width='4%' class='header_laporan' align='center'>Maret</th>
                <th width='4%' class='header_laporan' align='center'>April</th>
                <th width='4%' class='header_laporan' align='center'>Mei</th>
                <th width='4%' class='header_laporan' align='center'>Juni</th>
                <th width='4%' class='header_laporan' align='center'>Juli</th>
                <th width='4%' class='header_laporan' align='center'>Agustus</th>
                <th width='4%' class='header_laporan' align='center'>September</th>
                <th width='4%' class='header_laporan' align='center'>Oktober</th>
                <th width='4%' class='header_laporan' align='center'>November</th>
                <th width='4%' class='header_laporan' align='center'>Desember 1</th>
                <th width='4%' class='header_laporan' align='center'>Desember 2</th>
                <th width='4%' class='header_laporan' align='center'>Desember 3</th>
                <th width='4%' class='header_laporan' align='center'>Desember 4</th>
                <th width='4%' class='header_laporan' align='center'>Desember 5</th>
                <th width='4%' class='header_laporan' align='center'>Saldo Akhir</th>
            </tr>
        </thead>
        <tbody>
            @php 
