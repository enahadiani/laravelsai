            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <ul class="nav nav-tabs col-12 " role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#data-prev" role="tab" aria-selected="false"><span class="hidden-xs-down">Preview SPB</span></a></li>
                    </ul>
                    <div class="tab-content tabcontent-border col-12 p-0" style="margin-bottom: 2rem;">
                        ...
                        <div class="tab-pane row" id="data-prev" role="tabpanel">
                            <div id="prev-content" class="mt-4 px-3">
...
<script type="text/javascript">
        ...
        $.ajax({ 
            ...
            success:function(result) { 
                if(result.status) { 
                    ...
                    ajuPreview(result.data[0].no_bukti);
    ...
    function ajuPreview(id) {
        $.ajax({
            type: 'GET',
            url: "{{ url('siaga-trans/aju-spb-preview') }}",
            dataType: 'json',
            data:{no_bukti: id},
            async:false,
            success:function(result) {
                ...
                <table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td width='78' valign='top'>Terbilang :</td>
                            <td width='262' valign='top'>`+terbilang(line.nilai)+`</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td colspan="2">Jakarta, `+line.tanggal.substr(8,2)+` `+namaPeriode(line.tanggal.substr(0,4)+''+line.tanggal.substr(5,2))+` </td>
                        </tr>
                        <tr>
                            <td height='60'>&nbsp;</td>
                            <td>&nbsp;</td>
