...
class HakaksesController extends Controller
{
    ...
    public function index(){
        $client = new Client();
        $response = $client->request('GET',  config('api.url').'siaga-master/hakakses',[
            'headers' => [
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'siaga-master/hakakses',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function show($nik)
    {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'siaga-master/hakakses/'.$nik,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function update(Request $request, $nik)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('PUT',  config('api.url').'siaga-master/hakakses/'.$nik,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function destroy($nik)
    {
        try{
            ...
            $client = new Client();
            $response = $client->request('DELETE',  config('api.url').'siaga-master/hakakses/'.$nik,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
