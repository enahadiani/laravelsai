<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Bukti Kas Bank"/>
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            kode : ['periode','no_bukti','sum_ju'],
            nama : ['Periode','No Bukti','Sum Jurnal'],
            header : [['Periode', 'Nama'],['No Bukti','Keterangan'],['Kode']],
            headerpilih : [['Periode', 'Nama','Action'],['No Bukti','Keterangan','Action'],['Kode','Action']],
            columns: [
                [
                    { data: 'periode' },
                    { data: 'nama' }
            ...
            url :["{{ url('esaku-report/filter-periode-kb') }}","{{ url('esaku-report/filter-bukti-jurnal-kb') }}","{{ url('esaku-report/filter-sumju') }}"],
            parameter:[{},{
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('esaku-auth/form/rptKbBukti') }}";
        ...
        $("#sai-rpt-excel").click(function(e) {
            ...
            $("#saku-report #canvasPreview").table2excel({
                ...
                name: "BuktiKB_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
                filename: "BuktiKB_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('esaku-report/lap-buktijurnal-kb-pdf') }}?periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&no_bukti[]="+$no_bukti.type+"&no_bukti[]="+$no_bukti.from+"&no_bukti[]="+$no_bukti.to+"&sum_ju[]="+$sum_ju.type+"&sum_ju[]="+$sum_ju.from+"&sum_ju[]="+$sum_ju.to;
