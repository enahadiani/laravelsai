                ...
                <div class="row">
                    <div class="col-lg-7 m-b-30">
                        <div class="carousel" data-items="1">
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-7.jpg') }}" alt=""></a>
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-8.jpg') }}" alt=""></a>
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-7.jpg') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-5 p-l-40 p-r-40">
                        <div class="m-b-40">
                            <h5>EPC of Semawung MHPP 600 kW</h5>
                            <p>
                                Design, Fabrication and Construction of Semawung MHPP 600 kW (exclude Civil). This project situated at Kulon Progo, Central Java. The irrigation channel with 7 m3/s and head 12 m, using S-type kaplan turbine type.
                            </p>
                        </div>
                    </div>
                </div>
