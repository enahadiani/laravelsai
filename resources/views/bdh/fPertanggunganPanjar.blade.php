...
<!-- LIST DATA -->
<x-list-data judul="Pertanggungan Panjar" tambah="true" :thead="array('No Panjar','Tanggal','Deskripsi','Nilai','Progress','Aksi')" :thwidth="array(15,25,15,25,10,10)" :thclass="array('','','','','','text-center')" />
<!-- END LIST DATA -->
{{-- form data --}}
                               ...
                               <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_no_panjar" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-no_panjar" id="no_panjar" name="no_panjar" value="" title="">
                                        <span class="info-name_no_panjar hidden">
                                            <span></span>
                                        </span>
