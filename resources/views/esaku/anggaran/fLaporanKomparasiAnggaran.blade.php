...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Realisasi Komparasi Anggaran" padding="px-4 py-4"/>  
...
<x-report-result judul="Laporan Realisasi Komparasi Anggaran" padding="px-0 py-4"/>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        kode : ['tahun', 'kode_akun', 'kode_pp', 'jenis', 'periodik', 'realisasi'],
        nama : ['Tahun', 'Kode Akun', 'Kode PP', 'Jenis Akun', 'Periodik Laporan', 'Realisasi'],
            ...
            url :["{{ url('esaku-report/filter-tahun-anggaran') }}", "{{ url('esaku-report/filter-akun-anggaran') }}", "{{ url('esaku-report/filter-pp-anggaran') }}", "{{ url('esaku-report/filter-jenis-anggaran') }}", "{{ url('esaku-report/filter-periodik-anggaran') }}", ""],
            parameter:[
                {},
                {
                    'tahun[]': $tahun.type,
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/anggaran_rptLaporanKomparasiAnggaran') }}";
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Komparasi_Anggaran_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Komparasi_Anggaran_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
