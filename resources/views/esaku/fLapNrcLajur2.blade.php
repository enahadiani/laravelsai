<style>
            ...
            <div class="col-12">
                <div class="card" >
                    <div class="card-body pt-4 pb-2 px-4">
                        ...
                        <button type="button" id="btn-export" class="btn btn-light" style="float:right;width:110px"><i class="simple-icon-share-alt mr-1"></i> Export</button>
                    </div>
    ...
    <script>
        ...
        var $formData = "";
        $('#form-filter').submit('#form-filter', function(e){
            e.preventDefault();
