...
<!-- LIST DATA -->
<x-list-data judul="Data Pembatalan Droping" tambah="true" :thead="array('No Bukti','Tanggal','Jenis','No Dokumen','Deskripsi','Nilai','Aksi')" :thwidth="array(10,10,15,20,25,15,10)" :thclass="array('','','','','','','text-center')" />
<!-- END LIST DATA -->
...
<script>
   ...
   $.ajaxSetup({
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        ...
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah Data Pembatalan Droping');
