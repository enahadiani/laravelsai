                ...
                if(result.status){
                    if(typeof result.data !== 'undefined' && result.data.length>0){
                        for(i=0;i<result.data.length;i++){
                            control.addOption([{text:result.data[i].kode_ta + ' - ' + result.data[i].nama, value:result.data[i].kode_ta}]);
        ...
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    ...
                    $('#kode_ta')[0].selectize.setValue(result.data.data[0].kode_ta);
                    $('#kode_tingkat')[0].selectize.setValue(result.data.data[0].kode_tingkat);
                    $('#kode_jur')[0].selectize.setValue(result.data.data[0].kode_jur);
                    ...
                    if(result.data.data_detail.length > 0){
                        ...
                        for(var i=0;i<result.data.data_detail.length;i++){
                            ...
                            var kkm = line.kkm.slice(0,-2); 
                                ...
                                input += "<td width='30%'><input name='kkm[]' class='form-control inp-kkm ' value='"+kkm+"' required></td>";
                        ...
                        for(var i=0;i<result.data.data_detail.length;i++){
                            var line =result.data.data_detail[i];
                            getMatpel(result.data.data[0].kode_pp,'ke'+no);
