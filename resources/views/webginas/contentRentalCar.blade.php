                ...
                <div class="row">
                    <div class="content col-lg-8">
                        ...
                        <div class="post-image">
                            <a href="#">
                                <img height="486" width="650" alt="" src="{{ asset('asset_web/homepages/kegiatan/carRental.jpg') }}">
                            </a>
                        </div>
                        <div class="post-item-description" style="margin-top: 25px;">
                            <p>
                                Bisnis rental kendaraan bermotor merupakan salah satu bentuk usaha yang cukup potensial. 
                                Hal ini dikarenakan permintaan yang cukup tinggi dari pasar yang dalam menjalankan 
                                kegiatan atau aktifitas  usahanya  salah satunya dibutuhkan dukungan transportasi 
                                yang memadai.
                            </p>
                            <p>
                                PT. Trengginas Jaya merupakan salah satu perusahaan penyedia jasa transportasi 
                                khususnya dalam  memberikan layanan persewaan kendaraan bermotor. 
                                Adapun jenis kendaraan yang disewakan meliputi jenis  MPV, SUV dan Bus 
                                baik secara harian, bulanan maupun sewa jangka panjang dengan harga sewa  
                                dapat disesuaikan dengan kebutuhan dan keinginan Pelanggan.
                            </p>
                            <p>
                                <ol style="margin-left: 10px;">
                                    <li>
                                        <span style="font-weight: bold">Sewa Kendaraan Harian</span>
                                        <p>
                                            Jenis layanan ini adalah jenis persewaan kendaraan berdasarkan pemakaian 
                                            secara harian dengan maksimal waktu penggunaan selama 16 jam per hari. 
                                            Pada layanan jenis ini Pelanggan disediakan tenaga pengemudi.
                                        </p>
                                    </li>
                                    <li>
                                        <span style="font-weight: bold">Sewa Kendaraan Bulanan</span>
                                        <p>
                                            Jenis layanan ini merupakan jenis layanan persewaan kendaraan dengan 
                                            jangka waktu minimal satu bulan. Dalam pelaksanaannya terdapat dua pilihan 
                                            yaitu dapat menggunakan jasa pengemudi atau tanpa pengemudi.
                                        </p>
                                    </li>
                                    <li>
                                        <span style="font-weight: bold">Sewa Kendaraan Jangka Panjang</span>
                                        <p>
                                            Jenis layanan ini merupakan jenis layanan persewaan kendaraan untuk 
                                            jangka waktu lama yaitu minimal tiga bulan hingga lima tahun, jenis layanan 
                                            ini cocok untuk Pelanggan atau Perusahaan yang membutuhkan kendaraan 
                                            operasional guna mendukung kelancaran tugasnya. Dalam pelaksanaannya 
                                            terdapat dua pilihan yaitu dapat menggunakan jasa pengemudi atau tanpa 
                                            pengemudi.
                                        </p>
                                    </li>
                                </ol>
