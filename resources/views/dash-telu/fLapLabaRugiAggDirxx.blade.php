<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Laba Rugi Anggaran Direktorat"/>
    ...
    <script>
        ...
        $('#form-filter').submit(function(e){
            ...
            if($output.from == "Laporan"){
                xurl = "{{ url('dash-telu/form/rptLabaRugiAggDir') }}";
            }else{
                xurl = "{{ url('dash-telu/form/rptLabaRugiAggDirGrid') }}";
            }
        ...
        $('.navigation-lap').on('click', '#btn-back', function(e){
            ...
            if(aktif == "neraca-lajur"){
                xurl = "dash-telu/form/rptLabaRugiAggDir";
                $formData.delete('back');
        ...
        $('#modalEmail').on('submit','#formEmail',function(e){
            ...
            formData.append("subject","Laporan Laba Rugi Anggaran Direktorat ");
            $.ajax({
                type: 'POST',
