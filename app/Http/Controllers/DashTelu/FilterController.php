<?php
    ...
    class FilterController extends Controller {
        ...
        public function getFilterRektor() {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'ypt-report/filter-rektor',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ]
        ...
        public function getFilterFakultas() {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'ypt-report/filter-fakultas',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ]
        ...
        public function getFilterProdi() {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'ypt-report/filter-prodi',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ]
