    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#print-area").table2excel({
            ...
            name: "Skl_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Skl_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
