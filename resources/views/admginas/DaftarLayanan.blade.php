<style>
        ...
        <div class="col-12">
            <div class="card" >
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h5 style="position:absolute;top: 25px;">Data Layanan</h5>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <input class="form-control" type="text" id="id_layanan" name="id_layanan">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:800px">
            <div class="modal-content" style="border-radius:0.75em">
                <div class="modal-header py-0" style="display:block;">
                    <h6 class="modal-title py-2" style="position: absolute;">Preview Data Layanan <span id="modal-preview-nama"></span><span id="modal-preview-id" style="display:none"></span><span id="modal-preview-kode" style="display:none"></span> </h6>
    ...
    <script type="text/javascript">
        ...
        var dataTable = $("#table-data").DataTable({
            ...
            'ajax': {
                'url': "{{ url('admginas-master/layanan') }}",
                'async':false,
                'type': 'GET',
    ...
    // END LIST DATA
        ...
        $('#saku-datatable').on('click', '#btn-tambah', function(){
            $('#row-id').hide();
            $('#method').val('post');
            $('#judul-form').html('Tambah Data Layanan');
            $('#btn-update').attr('id','btn-save');
            $('#btn-save').attr('type','submit');
            $('#id_layanan').attr('readonly',false);
            $('#id_layanan').val('');
            $('#form-tambah')[0].reset();
        ...
        $('#form-tambah').validate({
            ...
            submitHandler: function (form) {
                ...
                var id = $('#id').val();
                if(parameter == "edit"){
                    var url = "{{ url('admginas-master/layanan') }}/"+id;
                    var pesan = "updated";
                }else{
                    var url = "{{ url('admginas-master/layanan') }}";
                    var pesan = "saved";
                }
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(result.status){
                    ...
                    $('#id_layanan').val(id);
                    $('#id').val(id);
                    $('#nama_layanan').val(result.data[0].nama_layanan);                              
                    $('#saku-datatable').hide();
                    $('#saku-form').show();
                }
