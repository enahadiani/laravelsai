...
class DashboardCCRController extends Controller {
    ...
    public function getDataBox(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-box',[
                'headers' => [
    ...
    public function getTopCCR(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-top',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getBidang(Request $r) {
        try {
            $req = $r->all();
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-bidang',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getTrendCCR(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-trend',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getTrendSaldoPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-trend-saldo',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getUmurPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-ccr-umur-piutang',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
