<footer id="footer" class="footer-background">
    ...
    <div class="copyright-content">
        <div class="container">
            <div class="copyright-text text-center">&copy; {{ date('Y') }} Java Turbine a member of <a class="link-footer" target="_blank" href="http://imajigroup.com/">Imaji group</a></div>
        </div>
    </div>
</footer>