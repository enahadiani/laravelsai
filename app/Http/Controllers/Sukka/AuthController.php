...
class AuthController extends Controller
{
    ...
    public function cek_auth(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-auth/login',[
                'form_params' => [
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    $response2 = $client->request('GET',  config('api.url').'sukka-auth/profile',[
                        'headers' => [
                    ...
                    return redirect('sukka-auth/');
                }else{
                    return redirect('sukka-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('sukka-auth/login')->with('alert',$message);
        }
    ...
    public function login(){
        return view('sukka.login');
    }

    public function logout(){
        Session::flush();
        return redirect('sukka-auth/login')->with('status','logout');
    }
    ...
    public function getMenu(){
        try {
            ...
            $response = $client->request('GET',  config('api.url').'sukka-auth/menu/'.$kodemenu,[
                'headers' => [
    ...
    public function getProfile(){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'sukka-auth/profile',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function updatePassword(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-auth/update-password',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function updatePhoto(Request $request){
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-auth/update-foto',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function updateBackground(Request $request){
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-auth/update-background',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function searchForm(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-auth/search-form',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function searchFormList(Request $request){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'sukka-auth/search-form-list',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
