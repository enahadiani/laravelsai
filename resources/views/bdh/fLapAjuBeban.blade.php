...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Pengajuan Beban" padding="px-4 py-4"/>  
...
<x-report-result judul="Laporan Pengajuan Beban" padding="px-0 py-4"/>
...
$('#form-filter').submit(function(e){
    ...
    xurl = "{{ url('bdh-auth/form/rptAjuBeban') }}";
