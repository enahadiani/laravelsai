...
class DashboardCFController extends Controller {
    ...
    public function getDataChartBulanan(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-cf-chart-bulanan',[
                'headers' => [
    ...
    public function getDataBox(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-cf-box',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getSoAkhirPerLembaga(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-tarbak-dash/data-cf-soakhir',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
