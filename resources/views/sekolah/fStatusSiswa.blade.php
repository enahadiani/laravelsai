...
<div class="container-fluid mt-3" style="font-size:13px">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card" style="max-height:560px !important">
                    <div class="card-body">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Data Status Siswa 
                ...
                <div class="card">
                    <form id="form-tambah" style=''>
                        <div class="card-body pb-0">
                            <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Form Status Siswa
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        // 'serverSide': true,
        'ajax': {
            'url': "{{url('/sekolah/getStatusSiswa')}}",
            'async':false,
            'type': 'GET',
    ...
    $('#form-tambah').on('change', '#kode_pp', function(){
     ...
     $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        var id = $('#kode_ss').val();
        if(parameter == "edit"){
            var url = "{{ url('/sekolah/postStatusSiswa') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/sekolah/postStatusSiswa') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('sekolah/deleteStatusSiswa') }}/"+id +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah/getStatusSiswa') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
