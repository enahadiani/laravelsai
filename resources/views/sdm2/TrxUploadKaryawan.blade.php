        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body form-header" style="padding-top:0.5rem;padding-bottom:0.5rem;min-height:48px">
                    <h6 id="judul-form" style="position:absolute;top:13px">Upload Data Karyawan</h6>
                </div>
                <div class="card-body pt-0 form-body" id="form-body">
                    <ul class="nav nav-tabs nav-tabs-custom col-12 " role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#data-pegawai"
                                role="tab" aria-selected="true"><span class="hidden-xs-down">Data Pegawai</span></a>
                        </li>
                    </ul>
                            ...
                            <div class="row nav-control" style="padding: 0px 5px;">
                                <div class="col-10">
                                    <div class="dropdown dropdown-container mx-0">
                                        <a class="btn dropdown-toggle mb-1 px-0" href="#" role="button"
                                            id="dropdown-import" data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false" style='font-size:18px'>
                                            <i class='simple-icon-doc'></i> <span style="font-size:12.8px">Upload Excel
                                                <i class='simple-icon-arrow-down' style="font-size:10px"></i></span>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdown-import"
                                            ...
                                            <a class="dropdown-item" href='#' id="download-template">Download
                                                Template</a>
...
$('#form-tambah').validate({
    ...
    submitHandler: function (form) {
        ...
        var param = $('#id').val();
        var url = "{{ url('esaku-trans/sdm-karyawan-simpan') }}";
...
$("#form-import").validate({
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "{{ url('esaku-trans/sdm-karyawan-upload') }}",
            dataType: 'json',
            data: formData,
            // async:false,
            contentType: false,
...
$('#process-upload').click(function(e){
    $.ajax({
        type: 'GET',
        url: "{{ url('esaku-trans/sdm-karyawan-load') }}",
        dataType: 'json',
        async:false,
...
$('#download-template').click(function(){
    ...
    var nik_user = "{{ Session::get('nikUser') }}";
    var nik = "{{ Session::get('userLog') }}";
    var link = "{{ config('api.url').'esaku-trans/sdm-export' }}?kode_lokasi="+kode_lokasi+"&nik_user="+nik_user+"&nik="+nik+"&type=template";
