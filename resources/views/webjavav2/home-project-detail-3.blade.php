                ...
                <div class="row">
                    <div class="col-lg-7 m-b-30">
                        <div class="carousel" data-items="1">
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-5.jpg') }}" alt=""></a>
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-6.jpg') }}" alt=""></a>
                            <a href="#" data-lightbox="gallery-image"><img src="{{ asset('asset_web/webjava/images/project-reference-5.jpg') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-5 p-l-40 p-r-40">
                        <div class="m-b-40">
                            <h5>Distribution Grid 20 kV of Sangir MHPP 2x5 MW</h5>
                            <p>
                                2 kms of 20 kV distribution grids constructed for Sangir MHPP situated at Jambi Province. JPE also supply line feeder, low voltage transmission line and road lighting for this project.
                            </p>
                        </div>
                    </div>
                </div>
