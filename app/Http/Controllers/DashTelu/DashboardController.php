<?php
    ...
    class DashboardController extends Controller
    {
        ...
        public function penyerapanInvestasiTahun(Request $request)
        {
            try{
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/penyerapan-investasi-tahun',
                    [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
        ...
        public function getLabaRugi5TahunYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/laba-rugi-5tahun-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPend5TahunYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/pend-5tahun-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPend5TahunTFYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/pend-5tahun-tf-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPend5TahunNTFYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/pend-5tahun-ntf-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPend5TahunKomposisiYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/pend-5tahun-komposisi-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPend5TahunGrowthYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/pend-5tahun-growth-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getBeban5TahunYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/beban-5tahun-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getBeban5TahunSDMYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/beban-5tahun-sdm-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getBeban5TahunNonSDMYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/beban-5tahun-non-sdm-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getBeban5TahunKomposisiYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/beban-5tahun-komposisi-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getBeban5TahunGrowthYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/beban-5tahun-growth-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getSHU5TahunYoY(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/shu-5tahun-yoy',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getMSHutangKlp(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/ms-hutang-klp',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getTarget(Request $request)
        {
            try{
                $client = new Client();
                $response = $client->request('GET', config('api.url').'ypt-dash/financial-target',
                    [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
        ...
        public function updateNoteTarget(Request $request)
        {
            try{
                $client = new Client();
                $response = $client->request('POST', config('api.url').'ypt-dash/note',
                    [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
