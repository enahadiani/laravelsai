    ...
    <!-- LIST DATA -->
    <x-list-data judul="Data Loker" tambah="" :thead="array('Kode','Nama','Status Aktif','Aksi')" :thwidth="array(20,55,15,10)" :thclass="array('','','','text-center')" />
    <!-- END LIST DATA -->
