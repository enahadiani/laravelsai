        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h6 style="position:absolute;top: 25px;">Sync Master Data</h6>
                ...
                <form id="form-filter">
                    ...
                    <div class="modal-body" style="border:none">
                        <div class="form-group row">
                            <label>Jenis Master</label>
                            <select class="form-control selectize" data-width="100%" name="inp-filter_jenis_master" id="inp-filter_jenis_master">
                                <option value='' disabled selected>Pilih Jenis Master</option>
                                <option value='BARANG'>BARANG</option>
                                <option value='BARANGKLP'>BARANGKLP</option>
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        "order": [[0, "desc"],[1, "desc"]],
        'ajax': {
            'url': "{{url('esaku-trans/sync-master')}}",
            'async':false,
            'type': 'GET',
    ...
    $('#table-data tbody').on('click','td',function(e){
        if($(this).index() != 4){
            ...
            <tr>
                <td>Nama Master Data</td>
                <td>`+data.jenis_master+`</td>
            </tr>
            <tr>
                <td>Total Rows</td>
    ...
    $('#modalFilter').on('submit','#form-filter',function(e){
        ...
        $.fn.dataTable.ext.search.push(
            function( settings, data, dataIndex ) {
                var jenis_master = $('#inp-filter_jenis_master').val();
                var col_jenis_master = data[2];
                if(jenis_master != ""){
                    if(jenis_master == col_jenis_master){
                        return true;
                    }else{
                        return false;
                    }
    ...
    $('#btn-reset').click(function(e){
        e.preventDefault();
        $('#inp-filter_jenis_master')[0].selectize.setValue('');
        jumFilter();
