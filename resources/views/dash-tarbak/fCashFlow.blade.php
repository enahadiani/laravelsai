<link rel="stylesheet" href="{{ asset('dash-asset/dash-tarbak/cf.dekstop.css?version=_').time() }}" />
...
(function() {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-cf-box') }}",
        data: {
            "periode[0]": "=", 
        ...
        success:function(result) {
            ...
            if(per_inflow_yoy < 0){
                $('#inflow-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_inflow_yoy,2)+'%')
                $('#inflow-yoy-percentage').addClass('red-text');
                $('#inflow-yoy-percentage').removeClass('green-text');
            }else{
                $('#inflow-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_inflow_yoy,2)+'%')
                $('#inflow-yoy-percentage').addClass('green-text');
                $('#inflow-yoy-percentage').removeClass('red-text');
            }

            if(per_inflow_mom < 0){
                $('#inflow-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_inflow_mom,2)+'%')
                $('#inflow-mom-percentage').addClass('red-text');
                $('#inflow-mom-percentage').removeClass('green-text');
            }else{
                $('#inflow-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_inflow_mom,2)+'%')
                $('#inflow-mom-percentage').addClass('green-text');
                $('#inflow-mom-percentage').removeClass('red-text');
            }

            if(per_outflow_yoy < 0){
                $('#outflow-yoy-percentage').html('<img alt="up-icon" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_outflow_yoy,2)+'%')
                $('#outflow-yoy-percentage').addClass('green-text');
                $('#outflow-yoy-percentage').removeClass('red-text');
            }else{
                $('#outflow-yoy-percentage').html('<img alt="up-icon" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_outflow_yoy,2)+'%')
                $('#outflow-yoy-percentage').addClass('red-text');
                $('#outflow-yoy-percentage').removeClass('green-text');
            }

            if(per_outflow_mom < 0){
                $('#outflow-mom-percentage').html('<img alt="up-icon" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_outflow_mom,2)+'%')
                $('#outflow-mom-percentage').addClass('green-text');
                $('#outflow-mom-percentage').removeClass('red-text');
            }else{
                $('#outflow-mom-percentage').html('<img alt="up-icon" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_outflow_mom,2)+'%')
                $('#outflow-mom-percentage').addClass('red-text');
                $('#outflow-mom-percentage').removeClass('green-text');
            }

            if(per_balance_yoy < 0){
                $('#balance-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_balance_yoy,2)+'%')
                $('#balance-yoy-percentage').addClass('red-text');
                $('#balance-yoy-percentage').removeClass('green-text');
            }else{
                $('#balance-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_balance_yoy,2)+'%')
                $('#balance-yoy-percentage').addClass('green-text');
                $('#balance-yoy-percentage').removeClass('red-text');
            }

            if(per_balance_mom < 0){
                $('#balance-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_balance_mom,2)+'%')
                $('#balance-mom-percentage').addClass('red-text');
                $('#balance-mom-percentage').removeClass('green-text');
            }else{
                $('#balance-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_balance_mom,2)+'%')
                $('#balance-mom-percentage').addClass('green-text');
                $('#balance-mom-percentage').removeClass('red-text');
            }

            if(per_closing_yoy < 0){
                $('#closing-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_closing_yoy,2)+'%')
                $('#closing-yoy-percentage').addClass('red-text');
                $('#closing-yoy-percentage').removeClass('green-text');
            }else{
                $('#closing-yoy-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_closing_yoy,2)+'%')
                $('#closing-yoy-percentage').addClass('green-text');
                $('#closing-yoy-percentage').removeClass('red-text');
            }

            if(per_closing_mom < 0){
                $('#closing-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(per_closing_mom,2)+'%')
                $('#closing-mom-percentage').addClass('red-text');
                $('#closing-mom-percentage').removeClass('green-text');
            }else{
                $('#closing-mom-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(per_closing_mom,2)+'%')
...
(function() {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-cf-chart-bulanan') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-cf-soakhir') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun,
