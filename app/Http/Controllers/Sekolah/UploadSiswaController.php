...
class UploadSiswaController extends Controller
{
    ...
    public function store(Request $request) {
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sekolah/siswa-upload-simpan',[
                'headers' => [
    ...
    public function loadDataTmp(Request $request) {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'sekolah/siswa-upload-tmp',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function uploadXLS(Request $request) {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sekolah/siswa-upload-import',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
