<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('asset_elite/node_modules/bootstrap/dist/css/bootstrap.min.css') }}" crossorigin="anonymous">
    ...
    <body>
        ...
        <script>
            ...
            function showPass() {
                ...
                if (x.type === "password") {
                    x.type = "text";
                    document.getElementById("buttonPass").style.backgroundImage = "url( {{ asset('asset_elite/icons/eye2.svg') }} )";// document.getElementById("myPass").style.paddingLeft = "30px";
                } else {
                    x.type = "password";
