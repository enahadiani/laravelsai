{{-- Referensi folder sekolah form fSiswa --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-3" style="padding-top:1rem;min-height:69.2px">
                    <h5 style="position:absolute;top: 25px;">Data Divisi</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-3 form-body">
                        ...
                        <div class="form-group row ">
                            <label for="nis" class="col-md-2 col-sm-12 col-form-label">Kode Divisi</label>
                            <div class="col-md-3 col-sm-12">
                                <input class="form-control" type="text" placeholder="Kode Divisi" id="kode" name="kode_divisi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nama" class="col-md-2 col-sm-12 col-form-label">Nama</label>
                            <div class="col-md-5 col-sm-12">
                                <input class="form-control" type="text" placeholder="Nama Divisi" id="nama" name="nama">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:800px">
            <div class="modal-content" style="border-radius:0.75em">
                <div class="modal-header py-0" style="display:block;">
                    <h6 class="modal-title py-2" style="position: absolute;">Preview Data Divisi <span id="modal-preview-nama"></span><span id="modal-preview-id" style="display:none"></span><span id="modal-preview-kode" style="display:none"></span> </h6>
                ...
                <form id="form-filter">
                    ...
                    <div class="modal-body" style="border:none">
                        <div class="form-group row">
                            ...
                            <select class="form-control" data-width="100%" name="inp-filter_divisi" id="inp-filter_divisi">
    ...
    var selectDivisi = $('#inp-filter_divisi').selectize();
                ...
                if(res.status){
                    ...
                    if(typeof result !== 'undefined' && result.length>0){
                        for(i=0;i<result.length;i++){
                            control.addOption([{text:result[i].kode_divisi + ' - ' + result[i].nama, value:result[i].kode_divisi}]);
                        }
                    }
                }
            }
    ...
    // EVENT CHANGE //
    $('#inp-filter_divisi').change(function(){
        jumFilter();
    });
    // END EVENT CHANGE //
    // LIST DATA
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function(){
        $('#row-id').hide();
        $('#id_edit').val('');
        $('#judul-form').html('Tambah Data Divisi');
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            var id = $('#kode').val();
            if(parameter == "edit"){
                var url = "{{ url('apv/divisi') }}/"+id;
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            }else{
                var url = "{{ url('apv/divisi') }}";
                var pesan = "saved";
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $('#judul-form').html('Edit Data Divisi');
        $.ajax({
            type: 'GET',
            url: "{{ url('apv/divisi') }}/" + id,
            dataType: 'json',
            async:false,
            success:function(res){
                var result= res.data;
    ...
    $('#table-data tbody').on('click','td',function(e){
        if($(this).index() != 2){
            ...
            var html = `<tr>
                <td style='border:none'>Kode Divisi</td>
     ...
     $('#modalFilter').on('submit','#form-filter',function(e){
        ...
        $.fn.dataTable.ext.search.push(
            function( settings, data, dataIndex ) {
                var divisi = $('#inp-filter_divisi').val();
                var col_divisi = data[0];
                if(divisi != ""){
                    if(divisi == col_divisi){
                        return true;
                    }else{
                        return false;
                    }
    ...
    $('#btn-reset').click(function(e){
        e.preventDefault();
        $('#inp-filter_divisi')[0].selectize.setValue('');
        jumFilter();
    });
