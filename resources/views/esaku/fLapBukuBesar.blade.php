<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Buku Besar"/>
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            ...
            url :["{{ url('esaku-report/filter-periode-keu') }}","{{ url('esaku-report/filter-akun') }}","{{ url('esaku-report/filter-mutasi') }}"],
            parameter:[],
            orderby:[[[0,"desc"]],[],[]],
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('esaku-report/lap-bukubesar-pdf') }}?periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&kode_akun[]="+$kode_akun.type+"&kode_akun[]="+$kode_akun.from+"&kode_akun[]="+$kode_akun.to+"&mutasi[]="+$mutasi.type+"&mutasi[]="+$mutasi.from+"&mutasi[]="+$mutasi.to;
