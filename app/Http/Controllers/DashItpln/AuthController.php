<?php
    ...
    class AuthController extends Controller 
    {
        ...
        public function cek_auth(Request $request)
        {
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dash-itpln/login',[
                    'form_params' => [
                ...
                if ($response->getStatusCode() == 200) { // 200 OK
                    ...
                    if($data["message"] == "success"){
                        ...
                        $response2 = $client->request('GET',  config('api.url').'dash-itpln/profile',[
                            'headers' => [
                        ...
                        return redirect('dash-itpln/');
                    }else{
                        return redirect('dash-itpln/login')->with('alert','Password atau NIK, Salah !');
                    }
                ...
                return redirect('dash-itpln/login')->with('alert',$message);
            }
        ...
        {
            Session::flush();
            return redirect('dash-itpln/login')->with('status','logout');
        }
        ...
        public function getMenu(){
            try{
                ...
                $response = $client->request('GET',  config('api.url').'dash-itpln/menu/'.$kodemenu,[
                    'headers' => [
         ...
         public function getProfile(){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'dash-itpln/profile',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ]
        ...
        public function updatePassword(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dash-itpln/update-password',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updatePhoto(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dash-itpln/update-foto',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updateBackground(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dash-itpln/update-background',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchForm(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dash-itpln/search-form',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchFormList(Request $request){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'dash-itpln/search-form-list',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
