...
<div class="container-fluid mt-3" style="font-size:13px">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card" style="max-height:560px !important">
                    <div class="card-body">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Data Mata Pelajaran 
                ...
                <div class="card">
                    <form id="form-tambah" style=''>
                        <div class="card-body pb-0">
                            <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Form Mata Pelajaran
                        ...
                        <div class="card-body pt-0" style='min-height:471px'>
                            ...
                            <div class="form-group row ">
								<label for="koed_matpel" class="col-3 col-form-label">Kode</label>
                                <div class="col-3">
                            ...
                            <div class="form-group row">
                                <label for="sifat" class="col-3 col-form-label">Sifat</label>
                                <div class="col-3">
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        if(parameter == "edit"){
            var url = "{{ url('/sekolah/postMatpel') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/sekolah/postMatpel') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('sekolah/deleteMatpel') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah/getMatpel') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
