...
class DashboardPiutangUnitController extends Controller {
    /**
    ...
    public function getDataBox(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-piutang-unit-box',[
                'headers' => [
    ...
    public function getKomposisiPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-piutang-unit-komposisi',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getTrendSaldoPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-piutang-unit-saldo',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getUmurPiutang(Request $r) {
        try {
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dash-ypt-dash/data-piutang-unit-umur',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
