<link href="{{ asset('asset_elite/dist/css/custom.css') }}" rel="stylesheet">
   ...
   function getPP(){
        ...
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    ...
                    $('#kode_ta')[0].selectize.setValue(ta);
    ...
    $('#form-tambah').on('click', '#add-row', function(){
        ...
        input += "<td width='50%'><input type='date' name='tanggal[]' class='form-control inp-date' required></td>";
        input += "<td width='30%'><input type='text' name='agenda[]' class='form-control inp-agenda' required></td>";
        input += "<td width='5%' class='text-center'><a class='btn btn-danger btn-sm hapus-item' style='font-size:8px'><i class='fa fa-times fa-1'></i></td>";
        input += "</tr>";
