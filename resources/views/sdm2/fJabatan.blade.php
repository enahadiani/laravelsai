...
{{-- SAKU TABLE --}}
<x-list-data judul="Data Jabatan" tambah="true" :thead="array('Kode','Nama','Status','Aksi')"
                ...
                <div class="card-body pt-0 form-body" id="form-body">
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input class="form-control" type="text" placeholder="Kode Jabatan" id="kode_jab"
                                name="kode_jab" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-row">
