...
class PembatalanPenyusutanController extends Controller
{
    /**
    ...
    public function getAktap(Request $request) {
        ...
        $client = new Client();
        $response = $client->request('GET',  config('api.url').'esaku-trans/susut-batal-noaktap',[
            'headers' => [
    ...
    public function getDataAktap(Request $request) {
        $periode = $this->convertPeriode($request->tanggal);
        $client = new Client();
        $response = $client->request('GET',  config('api.url').'esaku-trans/susut-batal-load',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $form = array(
                ...
                'nilai_batal' => $this->joinNum($request->nilai_referensi_susut),
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'esaku-trans/susut-batal',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
