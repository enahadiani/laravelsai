<link href="{{ asset('asset_elite/css/jquery.treegrid.css') }}" rel="stylesheet">
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            ...
            url :["{{ url('esaku-report/filter-periode-keu') }}","{{ url('esaku-report/filter-akun') }}"],
            parameter:[],
            orderby:[[[0,"desc"]],[]],
            width:[['30%','70%'],['30%','70%']],
        ...
        $('#form-filter').submit(function(e){
            ...
            //     xurl = "{{ url('esaku-auth/form/rptNrcLajurGrid') }}";
            // }else if($output.from == "Laporan Scroll"){
            //     xurl = "{{ url('esaku-auth/form/rptNrcLajurScroll') }}";
            // }
