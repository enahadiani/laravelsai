...
<body>
    <table class='table table-borderless' width='100%'>
        <tr>
            <td class='text-center px-0 py-0 judul-nama'>LAPORAN BUKU BESAR</td>
        </tr>
        <tr>
    ...
    @for($i=0;$i< count($data); $i++)
        ...
        <table class='table table-bordered info-table' style='width:100%'>
            <thead>
                ...
                <tr>
                    <td width='10%' height='23' class='header_laporan' align='center'>No Bukti</td>
                    <td width='10%' height='23' class='header_laporan' align='center'>No Dokumen</td>
