<?php
    ...
    class UploadDokJurnalController extends Controller {
        ...
        public function show(Request $request)
        {
            ...
            try{
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'esaku-trans/jurnal-dok',[
                    'headers' => [
        ...
        public function store(Request $request) {
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'esaku-trans/jurnal-dok',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function destroy(Request $request) {
            ...
            try{
                $client = new Client();
                $response = $client->request('DELETE',  config('api.url').'esaku-trans/jurnal-dok',
                [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
