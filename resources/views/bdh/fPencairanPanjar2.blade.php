...
<!-- LIST DATA -->
<x-list-data judul="Pencairan Panjar (versi 2)" tambah="true" :thead="array('No Panjar','Tanggal','NIK','Deskripsi','Nilai','Progress','Aksi')" :thwidth="array(15,25,15,25,10,10,10)" :thclass="array('','','','','','','text-center')" />
<!-- END LIST DATA -->
{{-- form data --}}
            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-6 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_nik_panjar" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-nik_panjar" id="nik_panjar" name="nik_panjar" value="" title="">
                                        <span class="info-name_nik_panjar hidden">
                                            <span></span>
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_akun_panjar" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-akun_panjar" id="akun_panjar" name="akun_panjar" value="" title="">
                                        <span class="info-name_akun_panjar hidden">
                                            <span></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_pemegang_if"></i>
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <div class="row mb-1">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control currency" type="text" placeholder="Total Debet" readonly id="total-pengajuan" name="nilai_pengajuan" value="0">
                                </div>
                    ...
                    <ul class="nav nav tabs col-12" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#data-peruntukan" role="tab" aria-selected="true">
                                <span>Item Peruntukan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content tabcontent-border col-12 p-0" style="margin-bottom:2.5rem">
                        <div class="tab-pane active" id="data-peruntukan" role="tabpanel">
...
<script type="text/javascript">
   ...
   $.ajaxSetup({
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        ...
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah Pencairan Panjar (versi 2)');
