...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Kartu Aktiva Tetap"/>
...
<x-report-result judul="Laporan Kartu Aktiva Tetap" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptKartuAktivaTetap') }}";
