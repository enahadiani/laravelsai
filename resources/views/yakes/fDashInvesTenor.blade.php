...
<div class="container-fluid mt-3">
    <div class="row header-dash">
        <div class="col-md-8 px-0">
            <h6 class='font-weight-light' style='color: #000000; font-size:22px !important;'>Tenor Bond  <span id='jplan' style="display:none;font-size:22px !important;"></span></h6>
    ...
    <div class="row body-dash" style="position: relative;">
        ...
        <h6 style='padding-left:12px;padding-bottom:10px'>Komposisi</h6>
...
function getParamDefault(){
    $.ajax({
        ...
        success: function(result){
            ...
            loadService('tenor','GET',"{{ url('yakes-dash/tenor') }}");
            loadService('komposisi','GET',"{{ url('yakes-dash/komposisi-tenor') }}");
        },
