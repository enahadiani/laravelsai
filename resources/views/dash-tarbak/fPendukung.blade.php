    ...
    function getNeraca(id,target1,target2,target3,jenis){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('/dash-tarbak-trans/pendukung-neraca') }}",
            dataType: 'json',
            data:{kode_neraca:id},
            async:false,
            success:function(result){
    ...
    var dataTable = generateTable(
        "table-data",
        "{{ url('dash-tarbak-trans/pendukung') }}", 
        [
            {
                "targets": [2],
                "visible": false,
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            // $iconLoad.show();
            if(param == "edit"){
                var url = "{{ url('/dash-tarbak-trans/pendukung') }}";
            }else{
                var url = "{{ url('/dash-tarbak-trans/pendukung') }}";
            }
                $.ajax({
    ...
    $('#table-data tbody').on('click','td',function(e){
        if($(this).index() != 2){
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('/dash-tarbak-trans/pendukung-detail') }}",
                dataType: 'json',
                data:{kode_dash: id},
                async:false,
                success:function(result){
    ...
    function hapusData(id){
        $.ajax({
            type: 'DELETE',
            url: "{{ url('dash-tarbak-trans/pendukung') }}",
            dataType: 'json',
            data:{kode_dash:id},
            async:false,
            success:function(result){
