<link rel="stylesheet" href="{{ asset('master.css') }}" />
    ...
    function getRef(id=null){
        $.ajax({
            type: 'GET',
            url: "{{ url('rtrw-master/reftrans-pindah-buku') }}",
            dataType: 'json',
            async:false,
            success:function(result){    
                if(result.status){
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            var id = $('#no_bukti').val();
            if(parameter == "edit"){
                var url = "{{ url('rtrw-master/pindah-buku') }}/"+id;
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            }else{
                var url = "{{ url('rtrw-master/pindah-buku') }}";
                var pesan = "saved";
    ...
    function hapusData(id){
        $.ajax({
            type: 'DELETE',
            url: "{{ url('rtrw-master/pindah-buku') }}/"+id,
            dataType: 'json',
            async:false,
            success:function(result){
                if(result.data.status){
