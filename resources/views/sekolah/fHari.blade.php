        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h5 style="position:absolute;top: 25px;">Data Hari</h5>
                    <button type="button" id="btn-tambah" class="btn btn-primary disabled" disabled style="float:right;"><i class="fa fa-plus-circle"></i> Tambah</button>
                </div>
            ...
            <div class="card">
                <form id="form-tambah" style=''>
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Form Kelas
