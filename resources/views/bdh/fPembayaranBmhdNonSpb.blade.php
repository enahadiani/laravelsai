...
<!-- LIST DATA -->
<x-list-data judul="Pembayaran BMHD NonSPB" tambah="true" :thead="array('No Bukti','Tanggal','Deskripsi','Nilai','Aksi')" :thwidth="array(10,10,30,15,10)" :thclass="array('','','','','','','','','','text-center')" />
<!-- END LIST DATA -->
{{-- form data --}}
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <div class="row mb-1">
                                ...
                                <div class="col-md-6 col-sm-12 mt-4">
                                    <button type="button" class="btn btn-primary mb-2 btn-proses">Tampil Data</button>
                                </div>
                                ...
                                <table class="table table-bordered table-condensed gridexample" id="spb-grid" style="width:100%;table-layout:fixed;word-wrap:break-word;white-space:nowrap">
                                    <thead style="background:#F8F8F8">
                                        <tr>
                                            ...
                                            <th style="width:15%">No BMHD</th>
                                            <th style="width:10%">Tanggal</th>
                                            <th width="20%">Deskripsi</th>
                                            <th width="15%">Akun BMHD</th>
...
<script type="text/javascript">
   ...
   $.ajaxSetup({
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        ...
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah Pembayaran BMHD NonSPB');
