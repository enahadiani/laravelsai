        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-3" style="padding-top:1rem;min-height:69.2px">
                    <h5 style="position:absolute;top: 25px;">Data Role</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-3 form-body">
                        ...
                        <div class="form-group row ">
                            <label for="kode" class="col-md-2 col-sm-12 col-form-label">Kode Role</label>
                            <div class="col-md-3 col-sm-12">
                                <input class="form-control" type="text" placeholder="Kode Role" id="kode" name="kode_role">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row ">
                            <label for="status" class="col-md-2 col-sm-12 col-form-label">Modul</label>
                            <div class="col-md-3 col-sm-12" >
                        ...
                        <div class="form-group row ">
                            <label for="atas" class="col-md-2 col-sm-12 col-form-label">Batas Atas</label>
                            <div class="col-md-3 col-sm-12">
                                <input class="form-control currency" type="text" placeholder="Batas Atas" id="atas" name="atas">
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="bawah" class="col-md-2 col-sm-12 col-form-label">Batas Bawah</label>
                            <div class="col-md-3 col-sm-12">
                                <input class="form-control currency" type="text" placeholder="Batas Bawah" id="bawah" name="bawah">
                            </div>
                        </div>
                        <ul class="nav nav-tabs col-12 " role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#data-grid" role="tab" aria-selected="true"><span class="hidden-xs-down">Data Jabatan</span></a> </li>
                        </ul>
                                ...
                                <div class='col-xs-12' style='min-height:420px; margin:0px; padding:0px;'>
                                    ...
                                    <thead style="background:#F8F8F8">
                                        <tr>
                                            ...
                                            <th style="width:5%"></th>
                                            <th style="width:13%">Kode Jabatan</th>
                                            <th style="width:15%">Nama Jabatan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
