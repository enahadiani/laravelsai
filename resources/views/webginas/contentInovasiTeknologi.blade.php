...
<head>
    ...
    <style>
        ...
        #tenaga-ahli tr:nth-child(even){
            background-color: #f2f2f2;
        }
        #tenaga-ahli tr:hover {
            ...
            <div class="container">
                ...
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="#">Inovasi Teknologi</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="content col-lg-8">
                        ...
                        <div class="post-image">
                            <a href="#">
                                <img height="486" width="650" alt="" src="{{ asset('asset_web/homepages/kegiatan/InovasiTeknologi.jpg') }}">
                            </a>
                        </div>
                        <div class="post-item-description" style="margin-top: 25px;">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6" style="margin-bottom:12px;">
                                    <div class="border" style="padding: 0;border-radius: 5px;height:52px; display:flex;justify-content:center;align-items:center;">
                                        <h5>E-Studia</h5>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6" style="margin-bottom:12px;">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6" style="margin-bottom:12px;">
                                    <div class="border" style="padding: 0;text-align:center;border-radius: 5px;height:52px; display:flex;justify-content:center;align-items:center;">
                                        <h5>Candidate Sentiment Analysis</h5>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6" style="margin-bottom:12px;">
                                    <div class="border" style="padding: 0;border-radius: 5px;height:52px; display:flex;justify-content:center;align-items:center;">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6" style="margin-bottom:12px;">
                                    <div class="border" style="padding: 0;text-align:center;border-radius: 5px;height:52px; display:flex;justify-content:center;align-items:center;">
                                        <h5>PATRIOT(Pendeteksi Bencana)</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
