<x-list-data judul="Data Pembatalan" tambah="" :thead="array('No Usulan', 'Kode PP', 'Tanggal', 'Keterangan', 'Nilai','Posisi','Aksi')" :thwidth="array(15,10,10,25,10,15,15)" :thclass="array('','','','','','','text-center')" back="true"/>
<script>
var actionHtmlNoED = "<a href='#' title='Detail' id='btn-view'><i class='simple-icon-eye' style='font-size:18px'></i></a> &nbsp;&nbsp;&nbsp;<a href='#' title='Print'  id='btn-print'><i class='simple-icon-printer' style='font-size:18px'></i></a> &nbsp;&nbsp;&nbsp; <a href='#' title='History'  id='btn-history'><i class='iconsminds-clock-back' style='font-size:18px'></i></a>";
