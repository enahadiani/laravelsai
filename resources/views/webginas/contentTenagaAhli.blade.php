                ...
                <div class="row">
                    <div class="content col-lg-8">
                        ...
                        <div class="post-image">
                            <a href="#">
                                <img height="486" width="650" alt="" src="{{ asset('asset_web/homepages/kegiatan/TenagaAhli.jpg') }}">
                            </a>
                        </div>
                        <div class="post-item-description" style="margin-top: 25px;">
                            <p>
                                Sebagai salah satu Perusahaan Penyedia Jasa Layanan Tenaga Ahli dalam bidang Information Teknologi (IT).
                            </p>
                            <p>
                                Tenaga Ahli IT yang kami sediakan merupakan lulusan terbaik dari Univeritas Telkom, 
                                adapun bidang tenaga ahli yang kami sediakan sebagai berikut :
                            </p>
                            <table id="tenaga-ahli">
                                <tbody>
                                    <tr>
