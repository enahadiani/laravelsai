<link rel="stylesheet" href="{{ asset('dash-asset/dash-tarbak/fp.dekstop.css?version=_').time() }}" />
<link rel="stylesheet" href="{{ asset('dash-asset/dash-tarbak/global.dekstop.css?version=_').time() }}" />
<link rel="stylesheet" href="{{ asset('dash-asset/dash-tarbak/tour/tour-default.css?version=_').time() }}" />

<script src="{{ asset('main.js') }}"></script>
<script src="{{ asset('dash-asset/dash-tarbak/dragging.js') }}"></script>
<script src="{{ asset('dash-asset/dash-tarbak/tour/tour.js') }}"></script>
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-fp-box') }}",
        data: {
            "periode[0]": "=", 
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-fp-pdpt') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun,
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-fp-beban') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun,
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-fp-shu') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun,
...
(function(){
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-fp-or') }}",
        data: {
            "periode[0]": "=", 
            "periode[1]": $filter2_kode,
            "tahun": $tahun,
          ...
          <div class="col-3 pl-1 pr-0">
                <div class="card card-dash  border-r-0">
                    <div class="row header-div">
                        ...
                        <div class="col-3">
                            <img alt="arrows-icon" class="icon-arrows cursor-pointer" src="{{ asset('dash-asset/dash-tarbak/icon/arrows.svg') }}">
                        </div>
                    </div>
...
@include('dash-tarbak.components.detail_fp')
