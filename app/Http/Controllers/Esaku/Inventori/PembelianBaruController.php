...
class PembelianBaruController extends Controller
{
    ...
    public function index(){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-trans/pembelian-baru',[
                'headers' => [
    ...
    public function getBarang(){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-trans/pembelian-baru-barang',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'esaku-trans/pembelian-baru',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
    ...
    public function show(Request $request) {
        try{
            $id = $request->no_bukti;
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-trans/pembelian-baru-detail?no_bukti='.$id,
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
    ...
    //         $response = $client->request('PUT',  config('api.url').'esaku-trans/pembelian-baru?no_bukti='.$no_bukti,[
    //                 'headers' => [
    //                     'Authorization' => 'Bearer '.Session::get('token'),
    //                     'Content-Type'     => 'application/json'
    //                 ],
    ...
    public function delete($id1,$id2,$id3) {
        try{
            $id = $id1."/".$id2."/".$id3;
            $client = new Client();
            $response = $client->request('DELETE',  config('api.url').'esaku-trans/pembelian-baru?no_bukti='.$id,
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
    ...
    public function getDataNota(Request $request) {
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-trans/pembelian-baru-nota',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
