            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pt-3 form-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="menu_mobile">Menu Mobile</label>
                                <div class="input-group">
                                    <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input class="form-control" type="text" placeholder="Password" id="password" name="pass" autocomplete="off" required>                                       
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="kode_menu_lab">Kode Menu Lab</label>
                                <input class="form-control" type="text" placeholder="Kode Menu Lab" id="kode_menu_lab" name="kode_menu_lab" autocomplete="off" required>                                       
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(result.status){
                    ...
                    getNIK('nik',id);
                    getKlpMenu('kode_klp_menu',result.data[0].kode_klp_menu);
                    getMenu('menu_mobile',result.data[0].menu_mobile);
                    getPath('path_view',result.data[0].path_view);
                    $('#saku-datatable').hide();
        ...
        switch(id) {
            case 'nik': 
                var settings = {
                    id : id,
                    header : ['Kode', 'Nama'],
                    url : "{{ url('silo-master/filter-nik') }}",
                    columns : [
                        { data: 'nik' },
                        { data: 'nama' }
                    ],
            ...
            case 'kode_klp_menu': 
                var settings = {
                    id : id,
                    header : ['Kode', 'Nama'],
                    url : "{{ url('silo-master/filter-klp-menu') }}",
                    columns : [
                        { data: 'kode_klp' },
                        { data: 'kode_klp' }
                    ],
            ...
            case 'menu_mobile': 
                var settings = {
                    id : id,
                    header : ['Kode', 'Nama'],
                    url : "{{ url('silo-master/filter-form') }}",
                    columns : [
                        { data: 'kode_form' },
                        { data: 'nama_form' }
                    ],
