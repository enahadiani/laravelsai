...
class JurnalUploadController extends Controller
{
    ...
    public function importExcel(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'esaku-trans/jurnal-upload-import',[
                'headers' => [
    ...
    public function getJurnalUploadTmp(Request $request)
    {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-trans/jurnal-upload-tmp',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'esaku-trans/jurnal-upload',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
