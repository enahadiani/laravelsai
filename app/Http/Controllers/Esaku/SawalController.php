...
class SawalController extends Controller
{
    ...
    public function importExcel(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'toko-trans/sawal-import',[
                'headers' => [
    ...
    public function getSawalTmp(Request $request)
    {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sawal-tmp',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'toko-trans/sawal',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
