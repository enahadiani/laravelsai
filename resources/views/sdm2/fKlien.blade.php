                ...
                <div class="card-body pt-0 form-body" id="form-body">
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="kode">Kode Klien</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <select name="flag_aktif" id="flag_aktif" class="form-control inp-flag_aktif">
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            if(parameter == "true"){
                ...
                var url = "{{ url('esaku-master/sdm-klien-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {

                var url = "{{ url('esaku-master/sdm-klien') }}";
                var pesan = "saved";
...
// EDIT FORM TRIGGER
    ...
    function editData(id) {
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-master/sdm-klien') }}",
            data: { kode: id },
            dataType: 'json',
            async:false,
    ...
    function hapusData(id) {
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    dataTable.ajax.reload();
                    showNotification("top", "center", "success",'Hapus Data','Data Klien ('+id+') berhasil dihapus ');
                    $('#modal-pesan-id').html('');
