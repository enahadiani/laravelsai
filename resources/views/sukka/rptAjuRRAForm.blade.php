<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad('sukka-report/lap-aju-rra-form', null, formData, null, function(res){
                        ...
                        <table class="table table-condensed table-bordered" width="100%"  id="table-m">
                            <tbody>
                                <tr>
                                        ...
                                        <td width="70%" id="print-unit">${line.periode}</td>
                                    </tr>
                                    <tr>
                                        <td width="5%">2</td>
                                        <td width="25">TANGGAL</td>
                                        <td width="70%" id="print-unit">${line.tanggal}</td>
                                    </tr>
                                    <tr>
                                        <td width="5%">3</td>
                                        <td width="25">KETERANGAN</td>
                                        <td width="70%" id="print-unit">${line.keterangan}</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>DIBUAT OLEH</td>
                                        <td id="print-pic">${line.nik_buat} ${line.nama_buat}</td>
                                    </tr>
                            </tbody>
                        </table>
                    </div>
