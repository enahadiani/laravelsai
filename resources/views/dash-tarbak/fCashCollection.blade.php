...
(function () {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-ccr-bidang') }}",
        dataType: 'json',
        async: true,
    ...
    $.ajax({
        ...
        success:function(result) {
            ...
            if (growth_all_yoy_ar >= 0){
                $('#all-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_all_yoy_ar,2)+'%');
                $('#all-yoy-ar-percentage').addClass('green-text');
                $('#all-yoy-ar-percentage').removeClass('red-text'); 
            }else{
                
                $('#all-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_all_yoy_ar,2)+'%');
            ...
            if (growth_all_yoy_inf >= 0){
                ...
                $('#all-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_all_yoy_inf,2)+'%');
                $('#all-yoy-inf-percentage').addClass('green-text');
                $('#all-yoy-inf-percentage').removeClass('red-text'); 
            }else{
                $('#all-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_all_yoy_inf,2)+'%');
            ...
            if (growth_now_yoy_ar >= 0){
                $('#now-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_now_yoy_ar,2)+'%');
                $('#now-yoy-ar-percentage').addClass('green-text');
                $('#now-yoy-ar-percentage').removeClass('red-text'); 
            }else{
                
                $('#now-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_now_yoy_ar,2)+'%');
            ...
            if (growth_now_yoy_inf >= 0){
                ...
                $('#now-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_now_yoy_inf,2)+'%');
                $('#now-yoy-inf-percentage').addClass('green-text');
                $('#now-yoy-inf-percentage').removeClass('red-text'); 
            }else{
                $('#now-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_now_yoy_inf,2)+'%');
            ...
            if (growth_prev_yoy_ar >= 0){
                $('#prev-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_prev_yoy_ar,2)+'%');
                $('#prev-yoy-ar-percentage').addClass('green-text');
                $('#prev-yoy-ar-percentage').removeClass('red-text'); 
            }else{
                
                $('#prev-yoy-ar-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_prev_yoy_ar,2)+'%');
            ...
            if (growth_prev_yoy_inf >= 0){
                ...
                $('#prev-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-green.png") }}">&nbsp;'+number_format(growth_prev_yoy_inf,2)+'%');
                $('#prev-yoy-inf-percentage').addClass('green-text');
                $('#prev-yoy-inf-percentage').removeClass('red-text'); 
            }else{
                $('#prev-yoy-inf-percentage').html('<img alt="up-icon" class="rotate-360" src="{{ asset("dash-asset/dash-tarbak/icon/fi-rr-arrow-small-up-red.png") }}">&nbsp;'+number_format(growth_prev_yoy_inf,2)+'%');
...
function getTopCCR(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-ccr-top') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
...
function getTrendCCR(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-ccr-trend') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
...
function getTrendSaldo(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-ccr-umur-piutang') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
