...
@endif
    ...
    function msgDialog(data){
        switch(data.type){
            ...
            case 'logout':
                ...
                //     window.location.href = "{{ url('bdh-auth/logout') }}";
                // }
    ...
    function updateNotifRead(){
        $.ajax({
            type: 'POST',
            url: "{{ url('bdh-auth/notif-update-status') }}",
            dataType: 'json',
            async:false,
            success:function(result){
                $('.count').remove();
    ...
    if(form !="" || form != "-"){
        loadForm("{{ url('bdh-auth/form')}}/"+form)
    }
    ...
    $('.sub-menu').on('click','.a_link',function(e){
        ...
        var url = "{{ url('bdh-auth/form')}}/"+form;
        if(form == "" || form == "-"){
            // alert('Form dilock!');
            return false;
        }else{
    ...
    //     source: function (cari, result) {
    //         $.ajax({
    //             url: "{{ url('bdh-auth/search-form-list') }}",
    //             data: {cari:cari},
    //             dataType: "json",
    //             type: "GET",
    ...
    <script>
        ...
        //     console.log('ok');
        //     loadForm("{{ url('bdh-auth/form') }}/fMasakun");
