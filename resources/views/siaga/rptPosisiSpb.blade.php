<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad('siaga-report/lap-posisi-spb', null, formData, null, function(res){
   ...
   function drawRptPage(data,res,from,to){
        ...
        if(data.length > 0){
            ...
            html+=judul_lap("LAPORAN POSISI APPROVAL SPB",lokasi,'Periode '+periode.fromname)+`
                <table width='100%' class='table table-bordered'>
                    <tr style="background:var(--theme-color-1);color:white">
                        ...
                        <td width='80' class='header_laporan' align='center'>Atensi</td>
                        ...
                        for (var x=0;x<data.length;x++)
                        {
                            ...
                            <td  class='isi_laporan'>`+line2.no_spb+`</td>
                            ...
                            <td  class='isi_laporan text-center'><a href='#' class='btn-print report-link' data-no_bukti='`+line2.no_spb+`'><i class='simple-icon-printer' style='font-size:18px !important'></i></a>&nbsp;&nbsp;<a href='#' class='btn-history report-link' data-no_bukti='`+line2.no_spb+`' ><i class='iconsminds-clock-back' style='font-size:18px !important'></i></a></td>
                            </tr>`;	
                            first = true;
                            no++;
