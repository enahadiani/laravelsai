        ...
        <div class="col-12 aset">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb px-0 pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Posisi Neraca</a></li>
                    <li class="breadcrumb-item active"><a href="#">Aset</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
function getAset(periode=null){
    $.ajax({
        type:"GET",
        url:"{{ url('/mobile-dash/ms-aset') }}",
...
$('.aset').on('click','#btnBack',function(e){
    e.preventDefault();
