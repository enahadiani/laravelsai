...
<body class="skin-default fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">sekolah admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <!-- text-->
                                <a href="{{url('sekolah/logout')}}" id="logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
        ...
        <div class="page-wrapper" style="min-height: 600px !important;">
            ...
            $(document).ready(function(){
                setTimeout(function(){
                    ...
                    window.location.href = "{{url('sekolah/logout')}}";
                }, 1000 * 60 * 60);
                    var urlAwal = "{{ url('/sekolah/form/dashSekolah')}}";
                    loadForm(urlAwal)
            });
            </script>
        </div>
