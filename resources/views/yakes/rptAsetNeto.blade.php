   ...
   function drawRptPage(data,res,from,to){
        ...
        // if(data.length > 0){
            ...
            <tr>
                ...
                <td width='8%' height='25'  class='header_laporan fs-1rem bold'><u>Catatan</u></td>
                <td width='18%' class='header_laporan text-right fs-1rem bold'><u>31 JANUARI 2020</u></td>
                <td width='18%' class='header_laporan text-right fs-1rem bold'><u>31 DESEMBER 2019</u></td>
                <td width='2%'></td>
            </tr>`;
            // var no=1;
            ...
            <tr>
                <td width='2%'>&nbsp;</td>
                <td width='52%' class='text-center'>PJ Keuangan dan Investasi</td>
                <td width='8%'>&nbsp;</td>
