...
function getDataBox() {
    $.ajax({
        ...
        success:function(result) {
            ...
            $('#capai_rka-cogs').removeClass('green-text')
            ...
            $('#capai_rka-gross_profit').removeClass('green-text');
            ...
            // }
            $('#capai_rka-opex').removeClass('green-text')
            ...
            // }
            $('#capai_rka-net_income').removeClass('green-text');
