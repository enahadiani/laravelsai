...
<div id='dash_page_gp' class="mt-120">
    <div class="row header-dash mb-2">
        <div class="col-md-8 px-0">
            <h6 class='font-weight-light' style='color: #000000; font-size:22px !important;'>Dashboard Gross Profit</h6>
        </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_1">
                            <div id='gp_port_chart1'></div>
                        </div>
                        <div class="tab-pane" id="tab_2">
                            <div id='gp_port_table1'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_3">
                            <div id='gp_port_chart2'></div>
                        </div>
                        <div class="tab-pane" id="tab_4">
                            <div id='gp_port_table2'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_5">
                            <div id='gp_port_chart3'></div>
                        </div>
                        <div class="tab-pane" id="tab_6">
                            <div id='gp_port_table3'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_7">
                            <div id='gp_port_chart4'></div>
                        </div>
                        <div class="tab-pane" id="tab_8">
                            <div id='gp_port_table4'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_9">
                            <div id='gp_port_chart5'></div>
                        </div>
                        <div class="tab-pane" id="tab_10">
                            <div id='gp_port_table5'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_11">
                            <div id='gp_port_chart6'></div>
                        </div>
                        <div class="tab-pane" id="tab_12">
                            <div id='gp_port_table6'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_13">
                            <div id='gp_port_chart7'></div>
                        </div>
                        <div class="tab-pane" id="tab_14">
                            <div id='gp_port_table7'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_15">
                            <div id='gp_port_chart8'></div>
                        </div>
                        <div class="tab-pane" id="tab_16">
                            <div id='gp_port_table8'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_17">
                            <div id='gp_port_chart9'></div>
                        </div>
                        <div class="tab-pane" id="tab_18">
                            <div id='gp_port_table9'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_19">
                            <div id='gp_port_chart10'></div>
                        </div>
                        <div class="tab-pane" id="tab_20">
                            <div id='gp_port_table10'></div>
                        </div>
                    </div>
                </div>
            </div>
...
var periode = "";
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.status){
                    ...
                    loadService('GP-Port','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: "All",field:"portofolio",modul:"GP"});
                    loadService('GP-Prod','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: "All",field:"produk",modul:"GP"});
                ...
                if(data.status){
                    switch(index){
                        case 'GP-Port':
                            ...
                            drawTable('#gp_port_table1', thead1, data.summary, ["portofolio","n2","n1","persen1"], "class='table table-striped table-bordered'", {"n2":"sepNum2Kanan","n1":"sepNum2Kanan","persen1":"sepNum2Kanan%"});
                            drawTable('#gp_port_table2', thead1, data.summary, ["portofolio","n3","n1","persen2"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan","n1":"sepNum2Kanan","persen2":"sepNum2Kanan%"});
    ...
    $('#form-filter').submit(function(e){
        ...
        loadService('GP-Port','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: dept,field:"portofolio",modul:"GP"});
        loadService('GP-Prod','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: dept,field:"produk",modul:"GP"});
