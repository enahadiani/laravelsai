    ...
    class AuthMobileController extends Controller {
        ...
        public function index()
        {
            if(!Session::get('login')){
                ...
                return view('mobile-tarbak.main');
            }            
        }
        ...
        {
            return view('mobile-tarbak.login');
        }
        ...
        public function cek_auth(Request $request)
        {
            try {
                    ...
                    if($data["message"] == "success"){
                        ...
                        if ($response2->getStatusCode() == 200) { // 200 OK
                            ...
                            if(count($res) > 0){
                                ...
                                if(isset($res[0]['kode_kelas'])){
                                    Session::put('kode_kelas',$res[0]['kode_kelas']);
                                }else{
                                    Session::put('kode_kelas','-');
                                }
                        ...
                        return redirect('mobile-tarbak/');
                        // var_dump('Sukses');
                    }else{
                        return redirect('mobile-tarbak/login')->with('alert','Password atau NIK, Salah !');
                    }
                ...
                return redirect('mobile-tarbak/login')->with('alert',$message);
            }
        ...
        {
            Session::flush();
            return redirect('mobile-tarbak/login')->with('status','logout');
        }
        ...
        public function getProfile(){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'sekolah/profile',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ]
        ...
        public function getMatpel(Request $request){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'mobile-sekolah/mata-pelajaran',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updatePassword(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'sekolah/update-password',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updatePhoto(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'sekolah/update-foto',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updateBackground(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'sekolah/update-background',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchForm(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'sekolah/search-form',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchFormList(Request $request){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'sekolah/search-form-list',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
