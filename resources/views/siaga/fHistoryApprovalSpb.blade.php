...
<!-- LIST DATA -->
<x-list-data judul="Data Histori Approval SPB" tambah="" :thead="array('No Aju', 'No Urut', 'ID Approval', 'Keterangan', 'Tanggal', 'Aksi')" :thwidth="array(15,10,15,20,20,10)" :thclass="array('','','','','','text-center')" />
<!-- END LIST DATA -->
