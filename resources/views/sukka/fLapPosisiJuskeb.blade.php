    ...
    <script>
        ...
        function loadFilterDefault(){
            $.ajax({
                type: 'GET',
                url: "{{ url('sukka-report/filter-default-juskeb') }}",
                dataType: 'json',
                async:false,
                success:function(result){   
                    if(result.status){
                        ...
                        generateRptFilter('#inputFilter',{
                            ...
                            url :["{{ url('sukka-report/filter-lokasi') }}","{{ url('sukka-report/filter-periode-juskeb') }}","{{ url('sukka-report/filter-pp') }}","{{ url('sukka-report/filter-bukti-juskeb') }}"],
                            parameter:[{},{
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('sukka-auth/form/rptPosisiJuskeb') }}";
        ...
        $('.navigation-lap').on('click', '#btn-back', function(e){
            ...
            if(aktif == "histori" || aktif == "form"){
                xurl = "sukka-auth/form/rptPosisiJuskeb";
                $formData.delete('back');
                $formData.delete('no_bukti[]');
                $formData.append('no_bukti[]', $no_bukti.type);
                $formData.append('no_bukti[]', $no_bukti.from);
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('sukka-report/lap-posisi-juskeb-pdf') }}?kode_lokasi[]="+$kode_lokasi.type+"&kode_lokasi[]="+$kode_lokasi.from+"&kode_lokasi[]="+$kode_lokasi.to+"&periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&kode_pp[]="+$kode_pp.type+"&kode_pp[]="+$kode_pp.from+"&kode_pp[]="+$kode_pp.to+"&no_bukti[]="+$no_bukti.type+"&no_bukti[]="+$no_bukti.from+"&no_bukti[]="+$no_bukti.to;
