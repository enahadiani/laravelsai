...
<script type="text/javascript">
    ...
    function drawLap(formData){
        saiPostLoad("{{ url('rtrw-report/lap-bukti-trans') }}", null, formData, null, function(res){
        ...
        if(data.length > 0){
            ...
            <div style='border-bottom: double #d7d7d7;padding:0 3rem'>
                <table class="borderless mb-2 table-kop-prev" width="100%" >
                    <tr>
                        <td width="25%" colspan="5" class="vtop"><h6 class="text-primary bold">BUKTI TRANSAKSI</h6></td>
                    ...
                    <table class="table table-striped table-body-prev mt-2" width="100%">
                        ...
                        for(var i=0;i<res.detail_jurnal.length;i++){
                            ...
                            if(data[0].no_bukti == line.no_bukti){
                                ...
                                det += "<td class='text-right' colspan='2'>"+number_format(line.debet)+"</td>";
                                det += "<td class='text-right'>"+number_format(line.kredit)+"</td>";
                                det += "</tr>";
                                no++;
                            }
                        }
                        ...
                        <th colspan="5"></th>
                        <th style="width:10%" class="text-right" colspan="2">`+number_format(total_debet)+`</th>
                        <th style="width:10%" class="text-right">`+number_format(total_kredit)+`</th>
                        </tr>`;
                        html+=det+`
                    </table>
