...
<!-- LIST DATA -->
<x-list-data judul="KB Penutupan I/F" tambah="true" :thead="array('No Kas Bank','Tanggal','No Ref','Deskripsi','Nilai','Aksi')" :thwidth="array(15,25,15,15,25,10)" :thclass="array('','','','','','text-center')" />
<!-- END LIST DATA -->
{{-- form data --}}
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                           <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <label for="no_reimburse" >No Reimburse</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_no_reimburse" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-no_reimburse" id="no_reimburse" name="no_reimburse" value="" title="">
                                        <span class="info-name_no_reimburse hidden">
                                            <span></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_no_reimburse"></i>
                                    </div>
                                </div>
                               <div class="col-md-6 col-sm-12">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <div class="row mb-1">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control currency" type="text" placeholder="Total Kas" readonly id="total-kas" name="total_kas" value="0">
                                </div>
                                <div class="col-md-6 col-sm-12">
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <label for="total_reimburse" >Total Reimburse</label>
                                    <input class="form-control currency" type="text" placeholder="Total Kredit" readonly id="total-reimburse" name="total_reimburse" value="0">
                                </div>
...
<script type="text/javascript">
   ...
   $.ajaxSetup({
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        ...
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah KB Penutupan I/F');
