...
<head>
    ...
    <style>
        ...
        #btn-eye {
            ...
            width: 40px;
            height: 40px;
            background: url("{{ asset('asset_dore/img/hide.svg') }}") no-repeat;
                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card" style="box-shadow:none">
                        <div class="form-side text-center px-0">
                            ...
                            <p class="mt-3" style="font-size:12px">Maaf demi keamanan data kamu jika tidak ada aktivitas
                                selama 1 jam <br> maka sistem akan keluar secara otomatis. Jangan khawatir kamu bisa
                                masuk kembali. </p>
                            <a type="button" href="{{ url('sdm2-auth/login') }}" class="btn mt-3"
                                style="border: 1px solid #000;width: 200px;">Masuk</a>
                        </div>
                    </div>
                </div>
            </div>
