<?php
    ...
    class LaporanController extends Controller {
        ...
        function getNeracaPDF(Request $request)
        {
            ...
            $ttd = $data['res']['ttd'];
            $tgl_awal = $data['res']['tgl_awal'].' '.$this->getNamaBulan($bln).' '.$tahun;
            $tgl_akhir = '31 '.$this->getNamaBulan(12).' '.$tahunseb;
            $tgl_sekarang = date('d').' '.$this->getNamaBulan(date('m')).' '.date('Y');
        ...
        function getArusKasUpload(Request $request){
            try{
    
                $client = new Client();
        
                $response = $client->request('GET',  config('api.url').'yakes-report/lap-arus-kas-upload',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        function getRekapReal(Request $request){
            try{
                ...
                $response = $client->request('GET',  config('api.url').'yakes-report/lap-rekap-real',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        function getRekapRealGrid(Request $request){
            try{
                ...
                $response = $client->request('GET',  config('api.url').'yakes-report/lap-rekap-real-grid',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        function getRekapRealDetail(Request $request){
            try{
                ...
                $response = $client->request('GET',  config('api.url').'yakes-report/lap-rekap-real-detail',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
