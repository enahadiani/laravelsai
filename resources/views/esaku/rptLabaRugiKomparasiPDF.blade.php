...
<body>
	...
	<table class='table table-bordered info-table' style='width:100%'>
        <thead>
            <tr>
                <th width='60%' height='25'  class='header_laporan text-center'>Deskripsi</th>
                <th width='20%' class='header_laporan text-center'>{{ $periode }}</th>
                <th width='20%' class='header_laporan text-center'>{{ $periode2 }}</th>
            </tr>
        </thead>
        <tbody>
