...
<div class="container-fluid mt-3" style="font-size:13px">
                        ...
                        <div class="card-body pt-0">
                            <div class="form-group row" id="row-id">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" type="text" placeholder="Kode Dokumen" id="no_dokumen" name="no_dokumen">
                                    </div>
                                </div>
                            <div class="form-group row">
                                <label for="nama" class="col-3 col-form-label">Deskripsi</label>
                                <div class="col-3">
                                    <input class="form-control" type="text" placeholder="Deskripsi Dokumen" id="deskripsi" name="deskripsi">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        var id = $('#id').val();
        if(parameter == "edit"){
            var url = "{{ url('dago-master/master-dokumen') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('dago-master/master-dokumen') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('dago-master/master-dokumen') }}/"+id,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status === 'SUCCESS'){
