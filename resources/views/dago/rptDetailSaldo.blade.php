...
<script type="text/javascript">
    ...
    function drawLap(formData){
       saiPost('dago-report/lap-detail-saldo', null, formData, null, function(res){
    ...
    var mon_html = `<div align='center' style='padding:10px' id='sai-rpt-table-export-tbl-daftar-reg'>
               ...
               mon_html+=`
                    ...
                    <table width="800px" class="table no-border">
                        ...
                        <thead>
                            <tr>
                                <td class="style16" align="center"><h4>LAPORAN DETAIL SALDO</h4></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <table width="100%" class="table table-striped color-table info-table">
                                        ...
                                        <tbody>`;
                                            var no=1;var det='';
                                            var byr=0;var nilai=0;var saldo=0;
                                            for (var x=0;x<data.length;x++)
                                            {
                                                var line2 = data[x];
                                                byr+= +parseFloat(line2.byr);
                                                nilai+= +parseFloat(line2.nilai);
                                                saldo+= +parseFloat(line2.saldo);
                                                ...
                                                <td class='isi_laporan text-right'>`+sepNumPas(line2.saldo)+`</td>
                                                </tr>`;	
                                                no++;
                                            ...
                                            <tr>
                                                ...
                                                <td class='isi_laporan text-right'>`+sepNumPas(saldo)+`</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
