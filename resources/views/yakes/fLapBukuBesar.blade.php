                                ...
                                <div class="px-4 pb-4 pt-2">
                                    <form id="form-filter">
                                        ...
                                        <div class="form-group row sai-rpt-filter-entry-row">
                                            ...
                                            <label for="mutasi" class="col-md-2 col-sm-12 col-form-label">Tampil Mutasi Nol</label>
                                            <div class="col-md-2 col-sm-12" >
    ...
    <script>
        ...
        function showFilter(param,target1,type = null){
            ...
            switch(par){
                case 'kode_akun[]': 
                    header = ['Kode', 'Nama'];
                    var toUrl = "{{ url('yakes-report/filter-akun') }}";
                    var columns = [
                        { data: 'kode_akun' },
                        { data: 'nama' }
                    ];
                ...
                case 'mutasi[]': 
                    header = ['Kode'];
                    var toUrl = "{{ url('yakes-report/filter-mutasi') }}";
                    var columns = [
                        { data: 'kode' }
                    ];
