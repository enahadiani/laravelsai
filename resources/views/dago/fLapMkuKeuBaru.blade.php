            ...
            <div class="col-12">
                <div class="card" >
                    <div class="card-body pt-2 pb-2 px-2" style="min-height:51px">
                        <h5 style="position: absolute;font-weight: bold;padding-left: 10px;top: 15px">Laporan MKU Keuangan</h5>
    ...
    <script>
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('dago-auth/form/rptMkuKeuBaru') }}";
        ...
        $("#sai-rpt-excel").click(function(e) {
            ...
            $("#saku-report #canvasPreview").table2excel({
                ...
                name: "LapMKUKeu_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
                filename: "LapMKUKeu_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
