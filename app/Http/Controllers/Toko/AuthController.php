...
class AuthController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!Session::get('login')){
            return redirect('toko-auth/login')->with('alert','Kamu harus login dulu');
        }
        else{
            return view('toko.main');
        }
        ...
        try {
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    return redirect('toko-auth/');
                }else{
                    return redirect('toko-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('toko-auth/login')->with('alert',$res["message"]);
        }
    ...
    public function logout(){
        Session::flush();
        return redirect('toko-auth/login')->with('alert','Kamu sudah logout');
    }
