...
class AuthController extends Controller
{
    ...
    public function cek_auth(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'admjava-auth/login',[
                'form_params' => [
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    $response2 = $client->request('GET',  config('api.url').'admjava-auth/profile',[
                        'headers' => [
                    ...
                    return redirect('admjava-auth/');
                }else{
                    return redirect('admjava-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('admjava-auth/login')->with('alert',$message);
        }
        
    }

    public function login(){
        return view('admjava.login');
    }

    public function register(){
        return view('admjava.register');
    }

    public function logout(){
        Session::flush();
        return redirect('admjava-auth/login')->with('status','logout');
    }
    ...
    public function getMenu(){
        try {
            ...
            $response = $client->request('GET',  config('api.url').'admjava-auth/menu/'.$kodemenu,[
                'headers' => [
    ...
    public function getProfile(){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'admjava-auth/profile',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function updatePassword(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'admjava-auth/update-password',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function updatePhoto(Request $request){
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'admjava-auth/update-foto',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function updateBackground(Request $request){
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'admjava-auth/update-background',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function searchForm(Request $request){
        ...
        try {
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'admjava-auth/search-form',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function searchFormList(Request $request){
        try {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'admjava-auth/search-form-list',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
