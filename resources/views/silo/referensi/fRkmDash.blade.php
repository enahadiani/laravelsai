    ...
    <div class="row dash-datatable">
        <div class="col-12">
            <x-list-data judul="Data Pengajuan" tambah="" :thead="array('No Bukti', 'PP', 'Tanggal', 'Keterangan', 'Komentar', 'Posisi','Aksi')" :thwidth="array(15,10,10,20,20,15,10)" :thclass="array('','','','','','','text-center')" />
        </div>
    </div>
