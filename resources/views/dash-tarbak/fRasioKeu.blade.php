...
<script type="text/javascript">
    ...
    function getJenis() {
        $.ajax({
            type:'GET',
            url: "{{ url('dash-tarbak-dash/data-rasio-jenis') }}",
            dataType: 'JSON',
    ...
    function getRasioYtd(periode,jenis_rasio,jenis,lokasi,tahun) {
        $.ajax({
            type:'GET',
            url: "{{ url('dash-tarbak-dash/data-rasio-ytd') }}",
            dataType: 'JSON',
    ...
    function getRasioYoY(periode,jenis_rasio,jenis,lokasi,tahun) {
        $.ajax({
            type:'GET',
            url: "{{ url('dash-tarbak-dash/data-rasio-yoy') }}",
            dataType: 'JSON',
            data:{'periode[0]':'=','periode[1]':periode,jenis:jenis,lokasi:lokasi,jenis_rasio:jenis_rasio,tahun:tahun},
            success: function(result) {
                if(result.status){
    ...
    function getYoYChart(periode,jenis_rasio,jenis,lokasi,tahun){
        $.ajax({
            type:'GET',
            url: "{{ url('dash-tarbak-dash/data-rasio-tahun') }}",
            dataType: 'JSON',
            data:{'periode[0]':'=','periode[1]':periode,jenis:jenis,lokasi:lokasi,jenis_rasio:jenis_rasio,tahun:tahun},
            success: function(result) {
