...
{{-- SAKU TABLE --}}
<x-list-data judul="Data Witel" tambah="true" :thead="array('Kode','Nama','Kode Lokasi','Aksi')"
                ...
                <div class="card-body pt-0 form-body" id="form-body">
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="kode">Kode Witel</label>
...
// TRIGGER FORM
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        $('#judul-form').html('Tambah Data Witel');
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            if(parameter == "true"){
                ...
                var url = "{{ url('esaku-master/sdm-witel-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {

                var url = "{{ url('esaku-master/sdm-witel') }}";
                var pesan = "saved";
...
// EDIT FORM TRIGGER
    ...
    function editData(id) {
        ...
        $('#judul-form').html('Edit Data Witel');

        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-master/sdm-witel') }}",
            data: { kode: id },
            dataType: 'json',
            async:false,
