        ...
        <!-- LIST DATA -->
        <x-list-data judul="Data Pengajuan Sedang diproses" tambah="" :thead="array('No Bukti','PP', 'Tanggal', 'Keterangan', 'Komentar','Posisi', 'Aksi')" :thwidth="array(10,10,10,25,20,15,10)" :thclass="array('','','','','','','text-center')" back="true"/>
        <!-- END LIST DATA -->
