    ...
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Penilaian" />
    ...
    <x-report-result judul="Penilaian" padding="px-0 py-4"/>
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            kode : ['kode_pp','kode_ta','kode_kelas','kode_matpel'],
            nama : ['PP','Tahun Ajaran','Kelas','Mata Pelajaran'],
            ...
            url :["{{ url('sekolah-report/filter-pp') }}","{{ url('sekolah-report/filter-ta') }}","{{ url('sekolah-report/filter-kelas') }}","{{ url('sekolah-report/filter-matpel') }}"],
            parameter:[{},{
