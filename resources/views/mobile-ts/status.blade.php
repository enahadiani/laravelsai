                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card" style="box-shadow:none">
                        <div class="form-side text-center px-0">
                            ...
                            <h2 class="mt-3"><b>{{ $sts_bayar }}</b></h2>
                            <p class="mt-3" style="font-size:12px">{{ $message }}</p>
                            <a type="button" href="{{ url('ts-auth') }}" class="btn mt-3" style="border: 1px solid #000;width: 200px;">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
