                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <label for="bukti_kirim">No. Bukti Kirim</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_bukti_kirim" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-bukti_kirim" id="bukti_kirim" name="bukti_kirim" value="" title="">
                                        <span class="info-name_bukti_kirim hidden">
                                            <span></span> 
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_bukti_kirim"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        switch(id) {
            ...
            case 'bukti_kirim':
                var options = {
                    id : id,
                    header : ['NIK', 'Nama'],
                    url : "{{ url('esaku-trans/filter-bukti-mutasi-kirim') }}",
                    columns : [
                        { data: 'no_bukti' },
                        { data: 'keterangan' }
                    ],
                    judul : "Daftar Mutasi Kirim",
                    pilih : "",
                    jTarget1 : "text",
                    jTarget2 : "text",
                    target1 : ".info-code_"+id,
