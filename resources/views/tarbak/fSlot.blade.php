<link href="{{ asset('asset_elite/dist/css/custom.css') }}" rel="stylesheet">
    <div class="container-fluid mt-3">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data Slot Jam Belajar 
            ...
            <div class="col-sm-12" style="height: 90px;">
                <div class="card">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Form Slot Jam Belajar
                    ...
                    <div class="card-body table-responsive pt-0" style='height:460px'>
                        <form class="form" id="form-tambah" style='margin-bottom:100px'>
                            ...
                            <div class="form-group row ">
								<label for="kode_slot" class="col-3 col-form-label">Kode</label>
                                <div class="col-3">
                                    <input class="form-control" type="text" placeholder="Kode Slot" id="kode_slot" name="kode_slot">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama" class="col-3 col-form-label">Nama</label>
                                <div class="col-9">
                                    <input class="form-control" type="text" placeholder="Nama Slot" id="nama" name="nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jam1" class="col-3 col-form-label">Jam Mulai</label>
                                <div class="col-3">
                                    <input class="form-control" type="time" placeholder="Jam Mulai" id="jam1" name="jam1">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jam2" class="col-3 col-form-label">Jam Selesai</label>
                                <div class="col-3">
                                    <input class="form-control" type="time" placeholder="Jam Selesai" id="jam2" name="jam2">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    $('#kode_slot,#nama,#jam1,#jam2,#kode_pp').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['kode_slot','nama','jam1','jam2','kode_pp'];
        if (code == 13 || code == 40) {
            e.preventDefault();
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        var id = $('#kode_slot').val();
        if(parameter == "edit"){
            var url = "{{ url('/tarbak/postSlot') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/tarbak/postSlot') }}";
            var pesan = "saved";
        }
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('tarbak/getSlot') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
            success:function(res){
                ...
                if(result.status){
                    ...
                    $('#kode_slot').val(id);
                    $('#method').val('put');
                    $('#kode_slot').attr('readonly', true);
                    $('#nama').val(result.data[0].nama);
                    $('#jam1').val(result.data[0].jam1);
                    $('#jam2').val(result.data[0].jam2);
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('tarbak/deleteSlot') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
