                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <!-- text-->
                                <a href="{{url('sai/logout')}}" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
            ...
            <script>
                        ...
                        success:function(result){    
                            if(!result.status){
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = "{{ url('sai/login') }}";
                                })
                            }else{
                ...
                $(document).ready(function(){
                    setTimeout(function(){
                        ...
                        window.location.href = "{{url('sai/logout')}}";
                    }, 1000 * 60 * 60);
