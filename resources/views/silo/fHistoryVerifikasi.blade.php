    <!-- LIST DATA -->
    <x-list-data judul="Data Histori Verifikasi Justifikasi Kebutuhan" tambah="" :thead="array('No Verifikasi', 'No Pengajuan', 'Status', 'Keterangan', 'Tanggal', 'Aksi')" :thwidth="array(15,15,20,30,15,10)" :thclass="array('','','','','','text-center')" />
    <!-- END LIST DATA -->
