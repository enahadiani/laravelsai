...
namespace App\Http\Controllers\Sdm2;
...
class AuthController extends Controller
{
        ...
        try {
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if ($data["message"] == "success") {
                    ...
                    return redirect('sdm2-auth/');
                } else {
                    return redirect('sdm2-auth/login')->with('alert', 'Password atau NIK, Salah !');
                }
            ...
            return redirect('sdm2-auth/login')->with('alert', $message);
        }
    }
    ...
    {
        Session::flush();
        return redirect('sdm2-auth/login')->with('status', 'logout');
    }
