                ...
                <form id="form-tambah" style=''>
                    <div class="card-body pt-0" style="height: 280px !important;">
                        ...
                        <div class="form-group row ">
                            <label for="kode_gudang" class="col-md-3 col-sm-3 col-form-label">Kode</label>
                        ...
                        <div class="form-group row">
                            <label for="telp" class="col-md-3 col-sm-3 col-form-label">No Telp</label>
                            <div class="col-md-3 col-sm-9">
    ...
    function showFilter(param,target1,target2){
        ...
        case 'kode_pp': 
            header = ['Kode', 'Nama'];
            var toUrl = "{{ url('esaku-master/gudang-pp') }}";
                var columns = [
                    { data: 'kode_pp' },
                    { data: 'nama' }
                ];
        ...
        case 'pic': 
            header = ['Kode', 'Nama'];
            var toUrl = "{{ url('esaku-master/gudang-nik') }}";
                var columns = [
                    { data: 'nik' },
                    { data: 'nama' }
                ];
