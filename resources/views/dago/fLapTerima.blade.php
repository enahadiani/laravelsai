        ...
        <div style="z-index: 1;position: fixed;right: auto;left: auto;margin-right: 15px;margin-left: 25px;margin-top:15px" class="col-sm-12" id="subFixbar">
            <div class="card " id="sai-rpt-filter-box;" style="padding:10px;">
                <div class="card-body" style="padding: 0px;">
                    <h4 class="card-title pl-1" style="font-size:16px"><i class='fas fa-file'></i> Laporan Tanda Terima</h4>
                    <hr>
                    <form id="formFilter">
    ...
    <div id='mySidepanel' class='sidepanel close'>
        ...
        <div class="row" style="margin-left: -5px;">
            <div class="col-sm-12">
                <div class="form-group" style='margin-bottom:0'>
                    <label for="no_kwitansi-selectized">No Terima</label>
                    <select name="no_kwitansi" id="no_kwitansi" class="form-control">
                    <option value="">Pilih No Terima</option>
                    </select>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
 var $loadBar = $('#loading-bar');
    ...
    function getTerima(periode=null,no_reg=null){
        $.ajax({
            type: 'GET',
            url: "{{ url('dago-report/filter-terima') }}",
            dataType: 'json',
            async:false,
