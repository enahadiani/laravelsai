...
class AuthController extends Controller
{
        ...
        try {
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    return redirect('java-auth/');
                }else{
                    return redirect('java-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('java-auth/login')->with('alert',$message);
        }
        
    }

    public function login(){
        return view('java.login');
    }
    ...
    public function logout(){
        Session::flush();
        return redirect('java-auth/login')->with('status','logout');
    }
