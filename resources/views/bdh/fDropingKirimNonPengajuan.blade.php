...
<!-- LIST DATA -->
<x-list-data judul="Data Kirim Non Pengajuan Droping" tambah="true" :thead="array('No Bukti','Tanggal','Deskripsi','Nilai','Aksi')" :thwidth="array(15,20,25,15,10)" :thclass="array('','','','','','text-center')" />
<!-- END LIST DATA -->
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                           ...
                           <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_akun_kas_bank" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-akun_kas_bank" id="akun_kas_bank" name="akun_kas_bank" value="" title="">
                                        <span class="info-name_akun_kas_bank hidden">
                                            <span></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_akun_kas_bank"></i>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
...
<script>
   ...
   $.ajaxSetup({
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        ...
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah Data Kirim Non Pengajuan Droping');
