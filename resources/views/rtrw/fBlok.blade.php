                ...
                <div class="card" style="height:540px">
                        <form class="form" id="form-tambah">
                            <div class="card-body pb-0">
                                <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data blok
                            ...
                            <div class="card-body table-responsive pt-0" style='height:461px'>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" type="text" placeholder="Masukkan Kode Blok " id="blok" name="blok" required>
                                    </div>
                                </div>
    ...
    $('#blok,#kode_pp').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['blok','kode_pp'];
        if (code == 13 || code == 40) {
            e.preventDefault();
