        ...
        if(/*data.length*/1 > 0){
            ...
            html+=`
                <table class='table table-bordered info-table'>
                    <thead>
                    <tr>
                        <td width='10' class='header_laporan' align='center'>No</td>
                        <td width='20' class='header_laporan' align='center'>Kode</td>
                        <td width='30' class='header_laporan' align='center'>Nama Akun</td>
                        <td width='20' class='header_laporan' align='center'>Kode PP</td>
                        <td width='20' class='header_laporan' align='center'>Saldo Awal</td>
                        <td width='20' class='header_laporan' align='center'>Debet</td>
                        <td width='20' class='header_laporan' align='center'>Kredit</td>
                        <td width='20' class='header_laporan' align='center'>Saldo Akhir</td>
                    </tr>
                    </thead>
                    <tbody>`;
            //         var so_awal_debet=0;
