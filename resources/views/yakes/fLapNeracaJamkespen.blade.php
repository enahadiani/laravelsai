<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Posisi Keuangan Program Jamkespen Manfaat Pasti" padding="px-4 py-4"/>  
    ...
    <script>
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('yakes-auth/form/rptNeracaJamkespen') }}";
        ...
        $('.navigation-lap').on('click', '#btn-back', function(e){
            ...
            if(aktif == "neraca-lajur"){
                xurl = "yakes-auth/form/rptNeracaJamkespen";
                $formData.delete('back');
