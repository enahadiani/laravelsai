...
class RoleController extends Controller
{
    ...
    public function index(){
        $client = new Client();
        $response = $client->request('GET',  config('api.url').'sukka-master/role',[
            'headers' => [
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'sukka-master/role',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
    ...
    public function show($kode_role)
    {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'sukka-master/role/'.$kode_role,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function update(Request $request, $kode_role)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('PUT',  config('api.url').'sukka-master/role/'.$kode_role,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Content-Type'     => 'application/json'
                ],
    ...
    public function destroy($kode_role)
    {
        try{
            $client = new Client();
            $response = $client->request('DELETE',  config('api.url').'sukka-master/role/'.$kode_role,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
