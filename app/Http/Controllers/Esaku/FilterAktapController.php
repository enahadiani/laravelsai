...
class FilterAktapController extends Controller {
    ...
    public function getAsset() {
        $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-report/filter-aset',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getJenis() {
        $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-report/filter-jenis',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getKlpAkun() {
        $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-report/filter-klp-akun',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getPeriodeSusut() {
        $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-report/filter-periode-susut',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
