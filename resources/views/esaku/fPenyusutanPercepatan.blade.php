            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                            <label for="total_perolehan">Total Perolehan</label>
                            <input type="text" placeholder="Total Perolehan" class="form-control currency" id="total_perolehan" name="total_perolehan" value="0" required readonly>
                        </div>
                        <div class="form-group col-md-3 col-sm-12">
