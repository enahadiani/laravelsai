...
<!-- LIST DATA -->
<x-list-data judul="Data Pertanggungan Beban" tambah="true" :thead="array('No Bukti','No Dokumen','Deskripsi','Nilai','Progress','Aksi')" :thwidth="array(15,20,15,10,0,10)" :thclass="array('','','','','','','','text-center')" />
<!-- END LIST DATA -->
<style>
            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <ul class="nav nav-tabs col-12 " role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#atensi-pembayaran" role="tab" aria-selected="true"><span class="hidden-xs-down">Atensi Pembayaran</span></a> </li>
                        ...
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#otorisasi" role="tab" aria-selected="true"><span class="hidden-xs-down">Otorisasi</span></a> </li>

                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#catatan-verificator" role="tab" aria-selected="true"><span class="hidden-xs-down">Catatan Verifikator</span></a> </li>
                        ...
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#budget" role="tab" aria-selected="true"><span class="hidden-xs-down">Budget</span></a> </li>

                    </ul>
                    <div class="tab-content tabcontent-border col-12 p-0">

                        <div class="tab-pane active" id="atensi-pembayaran" role="tabpanel">
                            ...
                            <div class='col-md-12' style='min-height:420px; margin:0px; padding:0px;'>
                                <table class="table table-bordered table-condensed gridexample" id="input-atensi" style="width:100%;table-layout:fixed;word-wrap:break-word;white-space:nowrap">
                                    <thead style="background:#F8F8F8">
                                        <tr>
                                            ...
                                            <th style="width:10%">Atensi</th>
                                            <th style="width:27%">Bank Cabang</th>
                                ...
                                <a type="button" href="#" data-id="0" title="add-row-atensi" class="add-row-atensi btn btn-light2 btn-block btn-sm">
...
<script>
    ...
    function addRowAtensi(param){
        var no = $('#'+param+'#input-atensi')
    }
    ...
    $('#form-tambah').on('click','.add-row-atensi', function(){
        console.log('klik add row atensi');
