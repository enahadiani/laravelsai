                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card" style="box-shadow:none">
                        <div class="form-side">
                            ...
                            <!-- </h6> -->
                            <form method="POST" action="{{ url('sdm2-auth/login') }}" id="form-login">
                                @csrf
                                    ...
                                    <div class="form-group col-md-12 col-sm-12">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input class="form-control" type="text" id="username" name="nik"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-10 mx-auto my-auto">
                            <div class="row" style="margin:0 auto;">
                                <div class="col-12 col-sm-12 text-center"><span
                                        style="font-size: 9px !important;">&copy;2020 PT Samudra Aplikasi
                                        Indonesia</span></div>
                            </div>
                        </div>
                    </div>
