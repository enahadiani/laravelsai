...
<body>
    <table class='table table-borderless' width='100%'>
        <tr>
            <td class='text-center px-0 py-0 judul-nama'>LAPORAN TRANSAKSI KAS BANK</td>
        </tr>
        <tr>
	...
	<table class='table table-bordered info-table' style='width:100%'>
        <thead>
            <tr>
                ...
                <td width='5%' class='header_laporan' align='center'>Posted</td>
