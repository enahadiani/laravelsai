                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <!-- text-->
                                <a href="{{url('toko-auth/logout')}}" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
        ...
        <div class="page-wrapper" style="min-height: 600px !important;">
            ...
            <script>
                ...
                $('.sidebar-nav').on('click','.a_link',function(e){
                    ...
                    var url = "{{ url('/toko-auth/form')}}"+"/"+form;
                    if(form == "" || form == "-"){
                        // alert('Form dilock!');
                        return false;
                    }else{
                ...
                $(document).ready(function(){
                    setTimeout(function(){
                        ...
                        window.location.href = "{{url('toko-auth/logout')}}";
                    }, 1000 * 60 * 60);

                    var form ="{{ Session::get('dash') }}";
                    if(form !="" || form != "-"){
                        loadForm("{{ url('toko-auth/form') }}/"+form);
                    }
                });
