...
<!-- LIST DATA -->
<x-list-data judul="Penyelesaian BMHD" tambah="true" :thead="array('No Bukti','Tanggal','Deskripsi','Nilai','Aksi')" :thwidth="array(10,10,30,15,10)" :thclass="array('','','','','','','','','','text-center')" />
<!-- END LIST DATA -->
{{-- form data --}}
            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <ul class="nav nav tabs col-12" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#data-bmhd" role="tab" aria-selected="true">
                                <span>Data BMHD</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane active" id="data-bmhd" role="tabpanel">
                            <div class="form-row mt-2">
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="akun_penyelesaian">Akun Penyelesaian</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_akun_penyelesaian" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="cbbl form-control inp-label-akun_penyelesaian" id="akun_penyelesaian" name="akun_penyelesaian" value="" title="" readonly>
                                        <span class="info-name_akun_penyelesaian hidden">
                                            <span id="label_akun_penyelesaian"></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden" style="cursor: pointer;"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_akun_penyelesaian"></i>
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="cbbl form-control inp-label-pp_m" id="pp_m" name="pp_m" value="" title="" readonly>
                                        <span class="info-name_pp_m hidden">
                                            <span id="label_pp_m"></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden" style="cursor: pointer;"></i>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="drk_m">Kode DRK</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_drk_m" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                        </div>
                                        <input type="text" class="cbbl form-control inp-label-drk_m" id="drk_m" name="drk_m" value="" title="" readonly>
                                        <span class="info-name_drk_m hidden">
                                            <span id="label_drk_m"></span>
                                        </span>
                                        <i class="simple-icon-close float-right info-icon-hapus hidden" style="cursor: pointer;"></i>
                                        <i class="simple-icon-magnifier search-item2" id="search_drk_m"></i>
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
