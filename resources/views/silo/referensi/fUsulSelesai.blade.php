        ...
        <div class="container-fluid mt-3">
            ...
            <!-- LIST DATA -->
            <x-list-data judul="Data Pengajuan Selesai" tambah="" :thead="array('No Usulan', 'Kode PP', 'Tanggal', 'Keterangan', 'Nilai','Posisi','Aksi')" :thwidth="array(15,10,10,25,10,15,15)" :thclass="array('','','','','','','text-center')"  back="true"/>
            <!-- END LIST DATA -->
        ...
        var dataTable = generateTable(
            "table-data",
            "{{ url('rkap-trans/aju-usul-selesai') }}", 
            [
                {
                    'targets': 0,
