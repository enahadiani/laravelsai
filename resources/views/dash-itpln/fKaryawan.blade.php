<link rel="stylesheet" href="{{ asset('master.css') }}" />
    ...
    var dataTable = generateTable(
        "table-data",
        "{{ url('dash-itpln-master/karyawan') }}", 
        [
    ...
    function getKodePP(id=null){
        $.ajax({
            type: 'GET',
            url: "{{ url('dash-itpln-master/unit') }}",
            dataType: 'json',
            data:{'kode_pp':id},
            async:false,
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            var id = $('#nik').val();
            if(parameter == "edit"){
                var url = "{{ url('dash-itpln-master/karyawan-ubah') }}/"+id;
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            }else{
                var url = "{{ url('dash-itpln-master/karyawan') }}";
                var pesan = "saved";
    ...
    function hapusData(id){
        $.ajax({
            type: 'DELETE',
            url: "{{ url('dash-itpln-master/karyawan') }}/"+id,
            dataType: 'json',
            async:false,
            success:function(result){
                if(result.data.status){
