<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Buku Kas Bank"/>
    ...
    <script>
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('esaku-auth/form/rptKbBukuBesar') }}";
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('esaku-report/lap-buku-kb-pdf') }}?periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&kode_akun[]="+$kode_akun.type+"&kode_akun[]="+$kode_akun.from+"&kode_akun[]="+$kode_akun.to+"&mutasi[]="+$mutasi.type+"&mutasi[]="+$mutasi.from+"&mutasi[]="+$mutasi.to;
