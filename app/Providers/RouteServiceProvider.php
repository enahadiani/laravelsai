...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapDashTarbakRoutes()
    {
        Route::prefix('dash-tarbak')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-tarbak/auth.php'));

        Route::prefix('dash-tarbak-dash')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-tarbak/dash.php'));

        Route::prefix('dash-tarbak-master')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-tarbak/master.php'));

        Route::prefix('dash-tarbak-trans')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-tarbak/trans.php'));

        Route::prefix('dash-tarbak-report')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-tarbak/report.php'));
    }

    protected function mapDashItplnRoutes()
    {
        Route::prefix('dash-itpln')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-itpln/auth.php'));

        Route::prefix('dash-itpln-dash')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-itpln/dash.php'));

        Route::prefix('dash-itpln-master')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-itpln/master.php'));

        Route::prefix('dash-itpln-trans')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-itpln/trans.php'));

        Route::prefix('dash-itpln-report')
            ->middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/dash-itpln/report.php'));
    }
