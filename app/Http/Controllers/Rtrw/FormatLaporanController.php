...
class FormatLaporanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'rtrw/format-laporan',[
                'headers' => [
    ...
    public function show(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'rtrw/format-laporan?kode_fs='.$request->kode_fs.'&modul='.$request->modul,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('PUT',  config('api.url').'rtrw/format-laporan',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function destroy(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('DELETE',  config('api.url').'rtrw/format-laporan?kode_fs='.$request->kode_fs.'&modul='.$request->modul.'&kode_neraca='.$request->kode_neraca,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getVersi()
    {
        try{
            ...
            $response = $client->request('GET',  config('api.url').'rtrw/format-laporan-versi',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getTipe(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('GET',  config('api.url').'rtrw/format-laporan-tipe?kode_menu='.$request->kode_menu,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getRelakun(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('GET',  config('api.url').'rtrw/format-laporan-relakun?kode_neraca='.$request->kode_neraca.'&modul='.$request->modul,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function simpanRelasi(Request $request)
    {
        ...
        try{
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'rtrw/format-laporan-relasi',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function simpanMove(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'rtrw/format-laporan-move',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
