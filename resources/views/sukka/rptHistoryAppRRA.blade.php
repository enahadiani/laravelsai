<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad('sukka-report/lap-history-app-rra', null, formData, null, function(res){
        ...
        if(data.length > 0){
            var html = `
                <table class="borderless mb-2 table-header" style="width:100%;" >
                    ...
                    <tr>
                        <td colspan="3" >LAPORAN HISTORY RRA</td>
            ...
            <table class="borderless mb-2 table-header" style="width:100%;" >
                    ...
                    <tr>
                        <td colspan="3" >LAPORAN HISTORY PENGAJUAN RRA</td>
                        <td colspan="12" class="vtop">&nbsp;</td>
                        <td class="vtop text-right">&nbsp;</td>
                    </tr>`;
                    if(typeof $periode == 'object'){
