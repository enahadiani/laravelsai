                                ...
                                <div class="col-md-4 col-sm-12 mt-2 mb-2">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_no_bukti" readonly="readonly"
                                                title="" data-toggle="tooltip" data-placement="top"></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-no_bukti" id="no_bukti"
                                            name="no_bukti" value="" title="" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12 mt-2">
                                    ...
                                    <input type="text" name="nominal" id="nominal"
                                        class="form-control inp-nominal currency" value="0" readonly>
                                </div>
                                <div class="col-md-4 col-sm-12 mt-2">
                                    <label for="modul">Modul</label>
                                    <input type="text" name="modul" id="modul" class="form-control inp-modul" value=""
                                        readonly>
                                </div>
                                <div class="col-md-4 col-sm-12 mt-2">
                                    <label for="tgl_aju">Tanggal Pengajuan</label>
                                    <input type="text" name="tgl_aju" id="tgl_aju" class="form-control inp-tgl_aju"
                                        value="" readonly>
                                </div>
                                <div class="col-md-4 col-sm-12 mt-2">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                            <span class="input-group-text info-code_nik_penerima" readonly="readonly"
                                                title="" data-toggle="tooltip" data-placement="top"></span>
                                        </div>
                                        <input type="text" class="form-control inp-label-nik_penerima" id="nik_penerima"
                                            name="nik_penerima" value="" title="" readonly>
                                ...
                                <div class="col-md-4 col-sm-12 mt-2">
                                    ...
                                    <input type="text" name="diserahkan_oleh" id="diserahkan_oleh"
                                        class="form-control inp-diserahkan_oleh" value="">
                                </div>
                            </div>
                        ...
                        <div class="form-group col-md-8 col-sm-12">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" rows="2" id="deskripsi" name="deskripsi" readonly
                                        required></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label for="catatan">Catatan</label>
                                    <textarea class="form-control" rows="2" id="catatan" name="catatan"
                                        required></textarea>
                                </div>
                            </div>
                        </div>
                ...
                if (result.status) {
                    ...
                    for (let z = 0; z < data_dok.length; z++) {
                        ...
                        html_dok +=
                            ...
                            no + " ' value='" + data_dok[z].kode_jenis +
                        ...
                        html_dok +=
                            ...
                            no + "' value='" + data_dok[z].nama + "' readonly></td>";

                        var dok =
                            "{{ config('api.url').'bdh-auth/storage' }}/" +
                            data_dok[z].no_gambar;
                        html_dok += "<td><span class='td-nama_file tdnmfileke" + no + " tooltip-span'>" +
                            data_dok[z].no_gambar +
                            "</span><input type='text' name='nama_file[]' class='form-control inp-nama_file nmfileke" +
                            no + " hidden'  value='" + data_dok[z].no_gambar + "' readonly></td>";
                        ...
                        if (data_dok[z].no_gambar != "-") {
                            var link = `<a class='download-dok' href='` + dok +
                                `'target='_blank' title='Download'><i style='font-size:18px' class='simple-icon-cloud-download'></i></a>`;
                        } else {
                            var link = ``;
                        }
                        html_dok += link + "</td></tr>";
