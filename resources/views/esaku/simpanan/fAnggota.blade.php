            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body form-header"
                        style="padding-top:0.5rem;padding-bottom:0.5rem;min-height:48px;">
                            ...
                            <div class="tab-pane active" id="umum" role="tabpanel">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input class='form-control datepicker' type="text" id="tgl_masuk"
                                            name="tgl_masuk" value="{{ date('d/m/Y') }}">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        <div style="margin-top:30px;margin-left:35px;top: 0; right: 25px;">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="flag-aktif"
                                                    class="form-control custom-control-input" id="flag_aktif" value="1"
                                                    checked>
                                                <label class="custom-control-label" for="flag_aktif">Aktif</label>
                                            </div>
                                        </div>
