...
<div id='dash_page_rev' class="mt-120">
                ...
                if(data.status){
                    switch(index){
                        case 'Revenue-Port':
                            ...
                            drawChart('pie', 'rev_port_chart4', [data.series4],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                            ...
                            drawChart('pie', 'rev_port_chart5', [data.series5],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
                        ...
                        case 'Revenue-Prod':
                            ...
                            drawTable('#rev_port_table10', thead4, data.summary, ["produk","n3"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan"});
                            ...
                            drawChart('pie', 'rev_port_chart9', [data.series4],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
                            ...
                            drawChart('pie', 'rev_port_chart10', [data.series5],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
