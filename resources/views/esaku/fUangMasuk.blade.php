                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <label for="terima_dari" >Di terima dari</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                                <span class="input-group-text info-code_terima_dari" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                            </div>
                                            <input type="text" class="form-control inp-label-terima_dari" id="terima_dari" name="terima_dari" value="" title="">
                                            <span class="info-name_terima_dari hidden">
                                                <span></span> 
                                            </span>
                                            <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                            <i class="simple-icon-magnifier search-item2" id="search_terima_dari"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <label for="akun_terima" >Akun Penerimaan</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend hidden" style="border: 1px solid #d7d7d7;">
                                                <span class="input-group-text info-code_akun_terima" readonly="readonly" title="" data-toggle="tooltip" data-placement="top" ></span>
                                            </div>
                                            <input type="text" class="form-control inp-label-akun_terima" id="akun_terima" name="akun_terima" value="" title="">
                                            <span class="info-name_akun_terima hidden">
                                                <span></span> 
                                            </span>
                                            <i class="simple-icon-close float-right info-icon-hapus hidden"></i>
                                            <i class="simple-icon-magnifier search-item2" id="search_akun_terima"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <label for="jenis_terima" >Jenis Penerimaan</label>
                                        <select class='form-control selectize' id="jenis_terima" name="jenis_terima">
                                        <option value=''>--- Pilih Jenis ---</option>
                                        <option value='TUNAI'>TUNAI</option>
                                        <option value='MCM'>MCM</option>
                                        <option value='TRANSFER'>TRANSFER</option>
                                        <option value='CHEKUE'>CHEKUE</option>
                                ...
                                <div class='col-md-12' style='min-height:420px; margin:0px; padding:0px;'>
                                    ...
                                    <thead style="background:#F8F8F8">
                                        <tr>
                                            ...
                                            <th style="width:33%">Kode Akun</th>
                                            <th style="width:20%">Keterangan</th>
                                            <th style="width:15%">Nilai</th>
                                            <th style="width:24">Kode PP</th>
                                            <th style="width:5%"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    function getDataTypeAhead(url,param,kode){
        $.ajax({
            ...
            success:function(result){    
                if(result.status) {
                    console.log(kode);
                    if(kode == "kode_akun" || kode == "kode_pp"){
    ...
    getDataTypeAhead("{{ url('esaku-trans/terima-dari') }}","terima_dari","kode");
    getDataTypeAhead("{{ url('esaku-trans/akun-terima') }}","akun_terima","kode_akun");
    getDataTypeAhead("{{ url('esaku-master/masakun') }}","kode_akun","kode_akun");

    $('#terima_dari').typeahead({
        source:$dtterima_dari,
        fitToElement:true,
    ...
    $('#akun_terima').typeahead({
        source:$dtakun_terima,
        fitToElement:true,
        displayText:function(item){
            return item.id+' - '+item.name;
        },
    ...
    $('#jenis_terima').typeahead({
        source:$dtjenis_terima,
        fitToElement:true,
        displayText:function(item){
            return item.id+' - '+item.name;
        },
            ...
            success:function(result){    
                if(result.status){
                    if(typeof result.daftar !== 'undefined' && result.daftar.length>0){
                        showInfoField('terima_dari',result.daftar[0].nik,result.daftar[0].nama);
                    }else{
                        $('#terima_dari').attr('readonly',false);
                        $('#terima_dari').css('border-left','1px solid #d7d7d7');
                        $('#terima_dari').val('');
                        $('#terima_dari').focus();
                    }
                }
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(result.status){
                    ...
                    $('#terima_dari').val(result.jurnal[0].terima_dari);
                    $('#akun_terima').val(result.jurnal[0].akun_terima);
                    $('#jenis_terima')[0].selectize.setValue(result.jurnal[0].jenis_terima);
                    if(result.detail.length > 0){
                        ...
                        for(var i=0;i<result.detail.length;i++){
                            ...
                            if(line.dc == "C"){
                                ...
                                input += "<td ><span class='td-kode tdakunke"+no+" tooltip-span'>"+line.kode_akun+" - "+line.nama_akun+"</span><input type='text' id='akunkode"+no+"' name='kode_akun[]' class='form-control inp-kode akunke"+no+" hidden' value='"+line.kode_akun+" - "+line.nama_akun+"' required='' style='z-index: 1;position: relative;'><a href='#' class='search-item search-akun hidden' style='position: absolute;z-index: 2;margin-top:8px;margin-left:-25px'><i class='simple-icon-magnifier' style='font-size: 18px;'></i></a></td>";
                                ...
                                input += "<td ><span class='td-pp tdppke"+no+" tooltip-span'>"+line.kode_pp+" - "+line.nama_pp+"</span><input type='text' id='ppkode"+no+"' name='kode_pp[]' class='form-control inp-pp ppke"+no+" hidden' value='"+line.kode_pp+" - "+line.nama_pp+"' required=''  style='z-index: 1;position: relative;'><a href='#' class='search-item search-pp hidden' style='position: absolute;z-index: 2;margin-top:8px;margin-left:-25px'><i class='simple-icon-magnifier' style='font-size: 18px;'></i></a></td>";
                    ...
                    $('#saku-form').show();
                    $('#kode_form').val($form_aktif);
                    showInfoField("terima_dari",result.jurnal[0].terima_dari,result.jurnal[0].nama_terima);
                    showInfoField("akun_terima",result.jurnal[0].akun_terima,result.jurnal[0].nama_akun);
                            ...
                            <table class="table table-striped table-body-prev mt-2" width="100%">
                               <tr style="background: var(--theme-color-1) !important;color:white !important">
                                ...
                                det+=`<tr style="background: var(--theme-color-1) !important;color:white !important">
                                    <th colspan="4"></th>
                                    <th style="width:10%;text-align:right">`+format_number(total_debet)+`</th>
                                    <th style="width:10%;text-align:right">`+format_number(total_kredit)+`</th>
                               </tr>`;
    ...
    // ENTER FIELD FORM
    $('#tanggal,#no_dokumen,#deskripsi,#terima_dari,#total_debet,#total_kredit').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['tanggal','no_dokumen','deskripsi','terima_dari','total_debet','total_kredit'];
        if (code == 13 || code == 40) {
            e.preventDefault();
        ...
        switch(id){
            case 'terima_dari':
                var options = {
                    id : id,
                    header : ['Kode', 'Nama'],
                    url : "{{ url('esaku-trans/terima-dari') }}",
                    columns : [
                        { data: 'kode' },
                        { data: 'nama' }
                    ],
    ...
    $('#form-tambah').on('change', '#terima_dari', function(){
        var par = $(this).val();
        getNIKPeriksa(par);
    });
        ...
        switch(par){
            case 'kode_akun[]': 
                var options = { 
                    ...
                    onItemSelected: function(data){
                        $('.akunke'+no).val(data.kode_akun+" - "+data.nama);
                        $('.tdakunke'+no).html(data.kode_akun+" - "+data.nama);
                    },
                    width : ["30%","70%"]
                };
            break;
            case 'kode_pp[]': 
                var options = { 
                    ...
                    target4 : "custom",
                    onItemSelected: function(data){
                        $('.ppke'+no).val(data.kode_pp+" - "+data.nama);
                        $('.tdppke'+no).html(data.kode_pp+" - "+data.nama);
                    },
                    width : ["30%","70%"]
                };
            break;
    ...
    $('#input-grid').on('keydown','.inp-kode, .inp-ket, .inp-nilai, .inp-pp, .inp-nama_pp',function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['.inp-kode','.inp-ket','.inp-nilai','.inp-pp','.inp-nama_pp'];
        var nxt2 = ['.td-kode','.td-ket','.td-nilai','.td-pp','.td-nama_pp'];
        if (code == 13 || code == 9) {
            e.preventDefault();
