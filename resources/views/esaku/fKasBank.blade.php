                ...
                <div class="card">
                    ...
                    <input type="hidden" id="method" name="_method" value="post">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        ...
                                        <option value='CHEKUE' selected>CHEKUE</option>
                        ...
                        <ul class="nav nav-tabs col-12 " role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#data-jurnal" role="tab" aria-selected="true"><span class="hidden-xs-down">Data Kasbank</span></a> </li>
                        </ul>
    ...
    function editData(id){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('/esaku-trans/kas-bank') }}/"+id,
            dataType: 'json',
            async:false,
        ...
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    ...
                    showNotification("top", "center", "success",'Hapus Data','Data Kasbank ('+id+') berhasil dihapus ');
    ...
    $('#saku-datatable').on('click', '#btn-tambah', function(){
        $('#row-id').hide();
        $('#method').val('post');
        $('#judul-form').html('Tambah Data Kasbank');
    ...
    $('#process-upload').click(function(e){
        $.ajax({
            type: 'GET',
            url: "{{ url('/esaku-trans/kas-bank-tmp') }}",
            dataType: 'json',
            async:false,
            success:function(res){
                var result= res.data;
    ...
    $('#saku-datatable').on('click', '#btn-upload', function(){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-trans/kas-bank-dok') }}",
            dataType: 'json',
            data:{no_bukti:id},
            async:false,
            success:function(res){
