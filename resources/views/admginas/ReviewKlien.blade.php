<style>
        ...
        <div class="col-12">
            <div class="card" >
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h5 style="position:absolute;top: 25px;">Data Review Klien</h5>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:800px">
            <div class="modal-content" style="border-radius:0.75em">
                <div class="modal-header py-0" style="display:block;">
                    <h6 class="modal-title py-2" style="position: absolute;">Preview Data Review <span id="modal-preview-nama"></span><span id="modal-preview-id" style="display:none"></span><span id="modal-preview-kode" style="display:none"></span> </h6>
    ...
    <script type="text/javascript">
        ...
        var dataTable = $("#table-data").DataTable({
            ...
            'ajax': {
                'url': "{{ url('admginas-master/review') }}",
                'async':false,
                'type': 'GET',
        ...
        $('#form-tambah').validate({
            ...
            submitHandler: function (form) {
                ...
                if(parameter == "edit"){
                    var url = "{{ url('admginas-master/review') }}/"+id;
                    var pesan = "updated";
                }else{
                    var url = "{{ url('admginas-master/review') }}";
                    var pesan = "saved";
                }
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        <tr>
                            ...
                            <td style='border:none'>`+result.data[0].nama_client+`</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style='border:none'>`+result.data[0].jabatan+`</td>
                        </tr>
                        <tr>
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(res.status){
                    ...
                    $('#id_review').val(id);
                    $('#id').val(id);
                    $('#nama_klien').val(result[0].nama_client); 
