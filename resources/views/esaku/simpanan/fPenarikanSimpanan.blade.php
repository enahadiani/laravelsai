        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body form-header" style="padding-top:0.5rem;padding-bottom:0.5rem;min-height:48px">
                    <h6 id="judul-form" style="position:absolute;top:13px">Penarikan Saldo Simpanan</h6>
                </div>
                ...
                <div class="card-body pt-3 form-body">
                        ...
                        <div class=" form-group col-md-4 col-sm-12">
                            <div class="row">
                                <div class="col-md-12 col-12 mb-3">
                                    <label for="no_kartu">Kas Bank Pengeluaran</label>
                                ...
                                <div class="col-md-12 col-12 mb-3">
                                    <label for="no_dokumen">Total Saldo</label>
                                    <input class='form-control' type="text" id="total_saldo" name="total_saldo"
                                        readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class=" nav nav-tabs col-12 " role=" tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#trans" role="tab"
                                aria-selected="false"><span class="hidden-xs-down">Daftar Simpanan</span></a> </li>
                    </ul>
