...
<div class="top-menu">
    <div class='navbar-top w-100 text-center'>
        <div class="header-icons d-inline-block align-middle">
            <a href="#" data-href='fRkmDash' class="header-icon btn btn-empty active" type="button" >
                <i class="simple-icon-home" style="font-size:1.5rem"></i>
                <h6 style="font-size:0.85rem !important">Home</h6>
            </a>
            <a href="#" data-href='fRkmDraft' class="header-icon btn btn-empty" type="button" >
                <i class="simple-icon-notebook" style="font-size:1.5rem"></i>
                <h6 style="font-size:0.85rem !important">Draft</h6>
            </a>
            <a href="#" data-href='fRkmAju' class="header-icon btn btn-empty" type="button" >
...
<script>
    ...
    $('#trans-body').load("{{ url('rkap-auth/form')}}/fRkmDash");
