        ...
        <div class="col-sm-12">
            <div class="card" style=''>
                <div class="card-body form-header" style="padding-top:1rem;padding-bottom:1rem;">
                    <h6 id="judul-form" style="position:absolute;top:25px">Upload Akun</h6>
                ...
                <div class="card-body form-body" style='background:#f8f8f8;padding: 0 !important;border-bottom-left-radius: .75rem;border-bottom-right-radius: .75rem;'>
                    ...
                    <div class="card" style='border-top-left-radius:0;border-top-right-radius:0'>
                        <div class="card-body">
                            ...
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#data-agg" role="tab" aria-selected="true"><span class="hidden-xs-down">Data Akun</span></a> </li>
                            </ul>
...
$("#form-import").validate({
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "{{ url('esaku-trans/akun-upload') }}",
            dataType: 'json',
            data: formData,
            // async:false,
            contentType: false,
            ...
            success:function(result){
                if(result.data.status){
                    if(result.data.validate){
                        ...
                        var link = "{{ config('api.url').'toko-trans/akun-export' }}?kode_lokasi="+kode_lokasi+"&nik_user="+nik_user+"&nik="+nik+"&type=non";
...
$('#download-template').click(function(){
    ...
    var nik_user = "{{ Session::get('nikUser') }}";
    var nik = "{{ Session::get('userLog') }}";
    var link = "{{ config('api.url').'toko-trans/akun-export' }}?kode_lokasi="+kode_lokasi+"&nik_user="+nik_user+"&nik="+nik+"&type=template";
