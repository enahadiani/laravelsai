    ...
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Guru Kelas"/>
    ...
    <x-report-result judul="Guru Kelas" padding="px-0 py-4"/>
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            kode : ['kode_pp','kode_ta','nik_guru'],
            nama : ['PP','Tahun Ajaran','NIK Guru'],
            ...
            url :["{{ url('sekolah-report/filter-pp') }}","{{ url('sekolah-report/filter-ta') }}","{{ url('sekolah-report/filter-guru') }}"],
            parameter:[{},{
