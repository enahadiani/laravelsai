...
class AuthController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!Session::get('login')){
            return redirect('bangtel-auth/login');
        }
        else{
            return view('bangtel.main');
        }
        ...
        try {
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    return redirect('bangtel-auth/');
                }else{
                    return redirect('bangtel-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('bangtel-auth/login')->with('alert',$message);
        }
        
    }

    public function login(){
        return view('bangtel.login');
    }

    public function register(){
        return view('bangtel.register');
    }

    public function logout(){
        Session::flush();
        return redirect('bangtel-auth/login')->with('status','logout');
    }
