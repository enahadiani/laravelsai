<?php 
    ...
    class AuthController extends Controller {
            ...
            try {
                ...
                if ($response->getStatusCode() == 200) { // 200 OK
                    ...
                    if($data["message"] == "success"){
                        ...
                        return redirect('ts-auth/');
                        // var_dump('Sukses');
                    }else{
                        return redirect('ts-auth/login')->with('alert','Password atau NIK, Salah !');
                    }
                ...
                return redirect('ts-auth/login')->with('alert',$message);
            }
        ...
        {
            Session::flush();
            return redirect('ts-auth/login')->with('status','logout');
        }
