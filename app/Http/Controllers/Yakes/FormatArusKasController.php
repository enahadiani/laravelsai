...
class FormatArusKasController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        try{
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'yakes-master/format-aruskas',[
                'headers' => [
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('PUT',  config('api.url').'yakes-master/format-aruskas',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getVersi()
    {
        try{
            ...
            $response = $client->request('GET',  config('api.url').'yakes-master/format-aruskas-versi',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getTipe(Request $request)
    {
        ...
        try{
            ...
            $response = $client->request('GET',  config('api.url').'yakes-master/format-aruskas-tipe?kode_menu='.$request->kode_menu,[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function simpanRelasi(Request $request)
    {
        ...
        try{
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'yakes-master/format-aruskas-relasi',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function simpanMove(Request $request)
    {
        ...
        try{
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'yakes-master/format-aruskas-move',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
