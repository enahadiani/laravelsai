                    ...
                    <div class="collapse show" id="collapseFilter">
                        <div class="px-4 pb-4 pt-2">
                            <form id="form-filter">
                                ...
                                <div id="inputFilter">
                                    <!-- COMPONENT -->
                                    <x-inp-filter kode="kode_sdm" nama="Status SDM" selected="1" :option="array('1','2','3','i')"/>
                                    <x-inp-filter kode="kode_gol" nama="Golongan" selected="1" :option="array('1','2','3','i')"/>
                                    <x-inp-filter kode="kode_jab" nama="Jabatan" selected="1" :option="array('1','2','3','i')"/>
                                    <x-inp-filter kode="kode_loker" nama="Lokasi Kerja" selected="1" :option="array('1','2','3','i')"/>
                                    <x-inp-filter kode="nik" nama="NIK Karyawan" selected="1" :option="array('3')"/>
                                    <!-- END COMPONENT -->
                                </div>
...
var $nik = {
    ...
    fromname : "{{ Session::get('userLog') }}",
    to : "",
    toname : "",
}
$('#nik-from').val("{{ Session::get('userLog') }}")
