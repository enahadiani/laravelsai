        ...
        <div class="col-12">
            <div class="card" >
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h5 style="position:absolute;top: 25px;">Data Flag Relasi</h5>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:800px">
            <div class="modal-content" style="border-radius:0.75em">
                <div class="modal-header py-0" style="display:block;">
                    <h6 class="modal-title py-2" style="position: absolute;"><span id="modal-preview-nama"></span><span id="modal-preview-id" style="display:none"></span> </h6>
    ...
    var dataTable = $("#table-data").DataTable({
        ...
        'ajax': {
            'url': "{{ url('yakes-master/flag-relasi') }}",
            'async':false,
            'type': 'GET',
    ...
    function showFilter(param,target1,target2){
        ...
        switch(par){
            ...
            case 'kode_flag_akun': 
            header = ['Kode', 'Nama'];
            var toUrl = "{{ url('yakes-master/flag-akun') }}";
                var columns = [
                    { data: 'kode_flag' },
                    { data: 'nama' }
                ];
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            // $iconLoad.show();
            if(param == "edit"){
                var url = "{{ url('/yakes-master/flag-relasi') }}/"+id;
            }else{
                var url = "{{ url('/yakes-master/flag-relasi') }}";
            }
    ...
    // ENTER FIELD FORM
    // $('#kode_flag_akun').keydown(function(e){
    ...
    // $('#input-grid').on('keydown', '.inp-pp', function(e){
    //     if(e.which == 40){
    //         e.preventDefault();
    //         var noidx =  $(this).closest('tr').find('.no-jurnal').html();
    //         target1 = "ppke"+noidx;
