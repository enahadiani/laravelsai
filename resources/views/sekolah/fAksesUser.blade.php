    ...
    function getKlpMenu(id=null){
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah-master/menu-klp') }}",
            dataType: 'json',
            data:{'kode_klp':id},
            async:false,
    ...
    function getKaryawan(id=null){
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah-master/karyawan') }}",
            dataType: 'json',
            data:{'kode_klp':id},
            async:false,
            success:function(result){    
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            var id = $('#nik').val();
            if(parameter == "edit"){
                var url = "{{ url('sekolah-master/akses-user') }}/"+id;
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            }else{
                var url = "{{ url('sekolah-master/akses-user') }}";
                var pesan = "saved";
    ...
    function hapusData(id){
        $.ajax({
            type: 'DELETE',
            url: "{{ url('sekolah-master/akses-user') }}/"+id,
            dataType: 'json',
            async:false,
            success:function(result){
                if(result.data.status){
