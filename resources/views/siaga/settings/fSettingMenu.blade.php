<link href="{{ asset('asset_elite/css/jquery.treegrid.css?version=_').time() }}" rel="stylesheet">
    <style>
        .ui-selected{
        ...
        <div class="row" id="saku-data" style="display:none">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div id="detMenu" class="card-body pt-0" style="height:calc(100vh - 310px);overflow-y:scroll">
...
<!-- JS Tree -->
<script src="{{ asset('asset_elite/js/jquery.treegrid.js?version=_').time() }}"></script>
<script type="text/javascript">
    ...
    function init(kode_klp){
        $.ajax({
            type: 'GET',
            url: "{{ url('siaga-master/set-setting-menu') }}",
            dataType: 'json',
    ...
    $(document).ready(function(){
        ...
        e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('siaga-master/set-setting-menu-move') }}",
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
