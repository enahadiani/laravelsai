<link rel="stylesheet" href="{{ asset('report.css') }}" />
    ...
    <script>
        ...
        $('#inputFilter').reportFilter({
            ...
            nama : ['Tahun','Kode FS','Level','Output'],
            header : [['Tahun'],['Kode', 'Nama'],['Kode'],['Kode']],
            headerpilih : [['Tahun','Action'],['Kode', 'Nama','Action'],['Kode','Action'],['Kode','Action']],
            columns: [
                [
                    { data: 'periode' }
                ],[
            ...
            url :["{{ url('esaku-report/filter-tahun') }}","{{ url('esaku-report/filter-fs') }}","{{ url('esaku-report/filter-level') }}","{{ url('esaku-report/filter-output') }}"],
            parameter:[],
            orderby:[[[0,"desc"]],[],[],[]],
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('esaku-report/lap-labarugi-bulan-pdf') }}?periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&kode_fs[]="+$kode_fs.type+"&kode_fs[]="+$kode_fs.from+"&kode_fs[]="+$kode_fs.to+"&level[]="+$level.type+"&level[]="+$level.from+"&level[]="+$level.to;
