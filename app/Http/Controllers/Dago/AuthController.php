...
class AuthController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!Session::get('login')){
            return redirect('dago-auth/login')->with('alert','Kamu harus login dulu');
        }
        else{
            return view('dago.main');
        }
        ...
        try {
            ...
            if ($response->getStatusCode() == 200) { // 200 OK
                ...
                if($data["message"] == "success"){
                    ...
                    return redirect('dago-auth/');
                }else{
                    return redirect('dago-auth/login')->with('alert','Password atau NIK, Salah !');
                }
            ...
            return redirect('dago-auth/login')->with('alert',$res["message"]);
        }
        
    }

    public function login(){
        return view('dago.login');
    }

    public function logout(){
        Session::flush();
        return redirect('dago-auth/login')->with('alert','Kamu sudah logout');
    }
