<link rel="stylesheet" href="{{ asset('master.css') }}" />
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form) {
            ...
            var id = $('#nik').val();
            if(parameter == "edit"){
                var url = "{{ url('sekolah-master/karyawan-ubah') }}/"+id;
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            }else{
                var url = "{{ url('sekolah-master/karyawan') }}";
                var pesan = "saved";
    ...
    function hapusData(id){
        $.ajax({
            type: 'DELETE',
            url: "{{ url('sekolah-master/karyawan') }}/"+id,
            dataType: 'json',
            async:false,
            success:function(result){
                if(result.data.status){
