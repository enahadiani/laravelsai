...
<div class="container-fluid mt-3" style="font-size:13px">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card" style="max-height:560px !important">
                    <div class="card-body">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Data Jurusan 
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        var id = $('#kode_jur').val();
        if(parameter == "edit"){
            var url = "{{ url('/sekolah/postJurusan') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/sekolah/postJurusan') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('sekolah/deleteJurusan') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah/getJurusan') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
