<?php
    ...
    class NotifUmumController extends Controller {
        ...
        public function index(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'ts/notif-umum',[
                    'headers' => [
        ...
        public function show(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'ts/notif-umum-detail',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function store(Request $request)
        {
            ...
            try{
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'ts/notif-umum',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function update(Request $request)
        {
            ...
            try{
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'ts/notif-umum-ubah',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function destroy(Request $request) {
            try{
                $client = new Client();
                $response = $client->request('DELETE',  config('api.url').'ts/notif-umum',
                [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
        ...
        public function deleteDokumen(Request $request) {
            try{
                $client = new Client();
                $response = $client->request('DELETE',  config('api.url').'ts-master/notif-umum-dok',
                [
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
        ...
        public function getSiswa(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'ts/notif-umum-siswa',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getKelas(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'ts/notif-umum-kelas',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function getPP(Request $request)
        {
            try{
                ...
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'ts/notif-umum-pp',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
