...
// TRIGGER FORM
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        $('#judul-form').html('Tambah Data BM');
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            if(parameter == "true"){
                ...
                var url = "{{ url('esaku-master/sdm-bm-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {

                var url = "{{ url('esaku-master/sdm-bm') }}";
                var pesan = "saved";
...
// EDIT FORM TRIGGER
    ...
    function editData(id) {
        ...
        $('#judul-form').html('Edit Data BM');

        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-master/sdm-bm') }}",
            data: { kode: id },
            dataType: 'json',
            async:false,
    ...
    function hapusData(id) {
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    dataTable.ajax.reload();
                    showNotification("top", "center", "success",'Hapus Data','Data BM ('+id+') berhasil dihapus ');
                    $('#modal-pesan-id').html('');
