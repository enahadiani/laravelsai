<link rel="stylesheet" href="{{ asset('report.css') }}" />
    <div class="row" id="saku-filter">
        <div class="col-12">
            <div class="card" >
                <x-report-header judul="Laporan Neraca"/>
    ...
    <script>
        ...
        $("#sai-rpt-pdf").click(function(e) {
            e.preventDefault();
            var link = "{{ url('telu-report/lap-neraca2-pdf') }}?periode[]="+$periode.type+"&periode[]="+$periode.from+"&periode[]="+$periode.to+"&kode_fs[]="+$kode_fs.type+"&kode_fs[]="+$kode_fs.from+"&kode_fs[]="+$kode_fs.to+"&output[]="+$output.type+"&output[]="+$output.from+"&output[]="+$output.to;
        ...
        $('#modalEmail').on('submit','#formEmail',function(e){
            ...
            formData.append("text","Berikut ini kami lampiran Laporan Neraca:");
            formData.append("subject","Laporan Neraca");
            $.ajax({
                type: 'POST',
