...
{{-- SAKU TABLE --}}
<x-list-data judul="Data Jabatan" tambah="true" :thead="array('Kode','Nama','Status','Aksi')" :thwidth="array(20,25,25,10)" :thclass="array('','','','text-center')" />
{{-- END SAKU TABLE --}}
                ...
                <div class="card-body pt-0 form-body" id="form-body">
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input class="form-control" type="text" placeholder="Kode Jabatan" id="kode_jab" name="kode_jab" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="nama">Nama</label>
                            <input class="form-control" type="text" placeholder="Nama Jabatan" id="nama" name="nama" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
...
// SAVE FORM TRIGGER
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            var id = $('#id').val();
            if(parameter == "true"){
                var url = "{{ url('esaku-master/sdm-jabatan-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {
                var url = "{{ url('esaku-master/sdm-jabatan') }}";
                var pesan = "saved";
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.data.status){
                        ...
                        last_add(dataTable,"kode_jab", kode);
                        $('#id_edit').val('false')
...
// EDIT FORM TRIGGER
    ...
    function editData(id) { 
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-master/sdm-jabatan') }}",
            data: { kode: id },
            dataType: 'json',
            async:false,
