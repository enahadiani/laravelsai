        ...
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card" style="max-height:560px !important">
                    <div class="card-body">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Data Angkatan 
                ...
                <div class="card">
                    <form id="form-tambah" style=''>
                        <div class="card-body pb-0">
                            <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Form Angkatan
...
$('#saku-form').on('submit', '#form-tambah', function(e){
    e.preventDefault();
        ...
        if(parameter == "edit"){
            var url = "{{ url('/sekolah/postAngkatan') }}/"+kode_akt1+"/"+kode_akt2;
            var pesan = "updated";
        }else{
            var url = "{{ url('/sekolah/postAngkatan') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('sekolah/deleteAngkatan') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        var temp = $(this).closest('tr').find('td').eq(1).html().split('-');
        var tingkat = $(this).closest('tr').find('td').eq(3).html();
        var kode_pp = temp[0]; 
        $iconLoad.show();
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah/getAngkatan') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
