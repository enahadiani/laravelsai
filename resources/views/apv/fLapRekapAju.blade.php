        ...
        <div style="z-index: 1;position: fixed;right: auto;left: auto;margin-right: 15px;margin-left: 25px;margin-top:15px" class="col-sm-12" id="subFixbar">
            <div class="card " id="sai-rpt-filter-box;" style="padding:10px;">
                <div class="card-body" style="padding: 0px;">
                    <h4 class="card-title pl-1" style="font-size:16px"><i class='fas fa-file'></i> Laporan Rekap Pengajuan</h4>
                    <hr>
                    <form id="formFilter">
    ...
    <div id='mySidepanel' class='sidepanel close'>
        ...
        <div class="row" style="margin-left: -5px;">
            <div class="col-sm-12">
                <div class="form-group" style='margin-bottom:0'>
                    <label for="kode_pp2-selectized">Regional</label>
                    <select name="kode_pp2" id="kode_pp2" class="form-control">
                    <option value="">Pilih Regional</option>
                    </select>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('#content-lap').on('click', '.detail-aju', function(e){
        e.preventDefault();
        var kode_pp = $(this).data('kode_pp');
        var kode_kota = $(this).data('kode_kota');
        var back = true;
        
        $formData.delete('kode_pp');
        $formData.append('kode_pp', kode_pp);
        $formData.delete('kode_kota');
        $formData.append('kode_kota', kode_kota);
        console.log(kode_pp,kode_kota);

        $formData.delete('back');
        $formData.append('back', back);
        xurl = "{{ url('/apv/form')}}/rptRekapAjuDet";
        $('#content-lap').load(xurl);
        // drawLapReg(formData);
    });
    ...
    $("#btnExport").click(function(e) {
        ...
        $("#canvasPreview").table2excel({
            ...
            name: "LapRekapAju",
            filename: "LapRekapAju.xls", // do include extension
