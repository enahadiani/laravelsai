...
<script type="text/javascript">
    ...
    function drawLap(formData){
        saiPostLoad('telu-report/lap-labarugi-agg', null, formData, null, function(res){
        ...
        saiPostGrid(url, null, formData, null, function(res){
            if(res.result.length > 0){
                ...
                for (var i=0; i < data.length; i++)
                {
                    ...
                    {
                        html+=`<td class='isi_laporan' align='center'>`+number_format(line.n3)+`%</td>
                        <td class='isi_laporan' align='center'>`+number_format(line.n4)+`%</td>
                        <td class='isi_laporan' align='center'>`+number_format(line.n1)+`%</td>
        ...
        $('.report-table').on('click','tr',function(){
            ...
            if(tipe == 'Posting'){
                ...
                if(!$(this).hasClass('clicked')){
                    ...
                    getChild(index,id,$formData,'telu-report/lap-labarugi-agg-detail',parent);
                }
