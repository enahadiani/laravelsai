            ...
            <div class="card">
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <ul class="nav nav-tabs col-12 " role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#data-prev" role="tab" aria-selected="false"><span class="hidden-xs-down">Preview Pengajuan</span></a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    function ajuPreview(id) {
        $.ajax({
            type: 'GET',
            url: "{{ url('siaga-trans/aju-preview') }}",
            dataType: 'json',
            data:{no_bukti: id},
            async:false,
            success:function(result) {
                        ...
                        <table class="table table-condensed table-borderless" width="100%" id='table-m'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id='print-kegiatan2' style='text-transform:capitalize'>`+terbilang(data.nilai)+`</td>
                                </tr>
                                <tr>
                                    <td>4</td>
