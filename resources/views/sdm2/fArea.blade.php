...
{{-- SAKU TABLE --}}
<x-list-data judul="Data Area" tambah="true" :thead="array('Kode','Nama','Kode Lokasi','Aksi')"
                ...
                <div class="card-body pt-0 form-body" id="form-body">
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="kode">Kode Area</label>
...
// TRIGGER FORM
    $('#saku-datatable').on('click', '#btn-tambah', function() {
        $('#judul-form').html('Tambah Data Area');
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            if(parameter == "true"){
                ...
                var url = "{{ url('esaku-master/sdm-area-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {

                var url = "{{ url('esaku-master/sdm-area') }}";
                var pesan = "saved";
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.data.status){
                        ...
                        last_add(dataTable,"kode_area", kode);
                        $('#id_edit').val('false')
...
// EDIT FORM TRIGGER
    ...
    function editData(id) {
        ...
        $('#judul-form').html('Edit Data Area');

        $.ajax({
            type: 'GET',
            url: "{{ url('esaku-master/sdm-area') }}",
            data: { kode: id },
            dataType: 'json',
            async:false,
    ...
    function hapusData(id) {
        $.ajax({
            ...
            success:function(result){
                if(result.data.status){
                    dataTable.ajax.reload();
                    showNotification("top", "center", "success",'Hapus Data','Data Area ('+id+') berhasil dihapus ');
                    $('#modal-pesan-id').html('');
