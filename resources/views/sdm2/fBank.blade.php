...
{{-- SAKU TABLE --}}
<x-list-data judul="Data Bank" tambah="true" :thead="array('Kode','Nama','Kode Lokasi','Aksi')"
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function (form, event) {
            ...
            if(parameter == "true"){
                ...
                var url = "{{ url('esaku-master/sdm-bank-update') }}";
                var pesan = "updated";
                var text = "Perubahan data "+id+" telah tersimpan";
            } else {

                var url = "{{ url('esaku-master/sdm-bank') }}";
                var pesan = "saved";
