...
<head>
    ...
    <style>
        ...
        .logo-single{
            background:url("{{ asset('img/mobile-tarbak/logo-tarbak.png') }}") no-repeat;
    ...
    <main>
        <div class="container" style="">
            <div class="row">
                ...
                <div class="col-12 col-md-10 mx-auto" style="height:55vh;background:#F2F2F2;border-top-left-radius:20px;border-top-right-radius:20px">
                    <div class="card auth-card" style="box-shadow:none;background:none">
                        <div class="form-side">
                            <form method="POST" action="{{ url('mobile-tarbak/login') }}" id="form-login">
                                @csrf
                                ...
                                @endif -->
                                <h6 style="font-size:22pt;font-weight:bold">Masuk</h6>
