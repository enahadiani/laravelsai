<link href="{{ asset('asset_elite/dist/css/custom.css') }}" rel="stylesheet">
    <div class="container-fluid mt-3">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Data Jenis Penilaian
            ...
            <div class="col-sm-12" style="height: 90px;">
                <div class="card">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4"><i class='fas fa-cube'></i> Form Jenis Penilaian
    ...
    var dataTable = $('#table-data').DataTable({
        ...
        // 'serverSide': true,
        'ajax': {
            'url': "{{url('/tarbak/getJenisPenilaian')}}",
            'async':false,
            'type': 'GET',
    ...
    $('#kode_jenis,#nama,#flag_aktif,#kode_pp').keydown(function(e){
        var code = (e.keyCode ? e.keyCode : e.which);
        var nxt = ['id_pekerjaan','nama','flag_aktif','kode_pp'];
        if (code == 13 || code == 40) {
            e.preventDefault();
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        if(parameter == "edit"){
            var url = "{{ url('/tarbak/postJenisPenilaian') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/tarbak/postJenisPenilaian') }}";
            var pesan = "saved";
        }
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('tarbak/getJenisPenilaian') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('tarbak/deleteJenisPenilaian') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
