<script type="text/javascript">
    ...
    function drawLap(formData){
        saiPostLoad('wisata-report/lap-bidang', null, formData, null, function(res){
   ...
   function drawRptPage(data,res,from,to){
        ...
        if(data.length > 0){
            ...
            html+=judul_lap("LAPORAN DATA BIDANG",'','')+`
                <table class='table table-bordered info-table'>
                    ...
                    for (var i=0; i < data.length ; i++)
                    {
                        var line  = data[i];
                        html +=`<tr>
                            <td class='isi_laporan' style='text-align:center;'>`+line.kode_bidang+`</td>
