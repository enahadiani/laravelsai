<style>
        ...
        <div class="col-12">
            <div class="card" >
                <div class="card-body pb-3" style="padding-top:1rem;">
                    <h5 style="position:absolute;top: 25px;">Data Sertifikat</h5>
                            ...
                            <div class="form-group col-md-10 col-sm-12">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input class="form-control" type="text" id="nama_sertifikat" name="nama_sertifikat">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="select-from-library-container mb-1">
                                            <label for="file_gambar">Gambar Sertifikat</label>
                                            <div class="select-from-library-button sfl-single mb-5" data-library-id="#libraryModal" data-count="1">
                                                <div id="div-banner" class="card d-flex flex-row mb-4 media-thumb-container justify-content-center align-items-center" style="cursor: pointer;">
                                                    ...
                                                    <img id="banner-preview" alt="banner" src="#" height="150" width="300" />
                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:800px">
            <div class="modal-content" style="border-radius:0.75em">
                <div class="modal-header py-0" style="display:block;">
                    <h6 class="modal-title py-2" style="position: absolute;">Preview Data Sertifikat <span id="modal-preview-nama"></span><span id="modal-preview-id" style="display:none"></span><span id="modal-preview-kode" style="display:none"></span> </h6>
    ...
    <script type="text/javascript">
        ...
        $('#saku-datatable').on('click', '#btn-tambah', function(){
            ...
            $('#id_edit').val('');
            $('#method').val('post');
            $('#judul-form').html('Tambah Data Sertifikat');
        ...
        var dataTable = $("#table-data").DataTable({
            ...
            'ajax': {
                'url': "{{ url('admginas-master/sertifikat') }}",
                'async':false,
                'type': 'GET',
        ...
        $('#form-tambah').validate({
            ...
            submitHandler: function (form) {
                ...
                if(parameter == "edit"){
                    var url = "{{ url('admginas-master/sertifikat') }}/"+id;
                    var pesan = "updated";
                }else{
                    var url = "{{ url('admginas-master/sertifikat') }}";
                    var pesan = "saved";
                }
        ...
        $('#table-data tbody').on('click','td',function(e){
            if($(this).index() != 2){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ url('admginas-master/sertifikat') }}/" + id,
                    dataType:"JSON",
                    success: function(result) {
                        var html = `<tr>
                            <td style='border:none'>ID Sertifikat</td>
                            <td style='border:none'>`+id+`</td>
                        </tr>
                        <tr>
                            <td style='border:none'>Nama Sertifikat</td>
                            <td style='border:none'>`+result.data[0].nama_sertifikat+`</td>
                        </tr>
                        <tr>
                            <td>Logo</td>
                            <td>
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(res.status){
                    ...
                    $('#id').val(id);
                    $('#nama_sertifikat').val(result[0].nama_sertifikat);
                    $('#banner-preview').show();
                    $('#span-banner').hide();     
