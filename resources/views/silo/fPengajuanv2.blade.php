    ...
    <!-- LIST DATA -->
    <x-list-data judul="Data Justifikasi Pengajuan" tambah="true" :thead="array('No Bukti', 'No Dokumen', 'Regional', 'Waktu', 'Kegiatan', 'Posisi', 'Nilai Pengadaan', 'Nilai Finish', 'Aksi')" :thwidth="array(10,25,20,10,20,10,10,10,25)" :thclass="array('','','','','','','','','text-center')" />
    <!-- END LIST DATA -->
    <!-- FORM  -->
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control inp-label-kode_divisi" id="kode_divisi" name="kode_divisi" autocomplete="off" data-input="cbbl" value="" title="" required readonly>
    ...
    <script type="text/javascript">
        ...
        function setDivisi(kode_cbbl, value) {
            $.ajax({
                type: 'GET',
                ...
                success:function(res){  
                    if(res.status){
                        if(typeof res.daftar !== 'undefined' && res.daftar.length>0){
                            var data = res.daftar;
                            var filter = data.filter(data => data.kode_divisi == res.kode_divisi);
                            if(filter.length > 0) {
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(result.status){
                        ...
                        setDivisi('kode_divisi', result.data[0].kode_divisi)
