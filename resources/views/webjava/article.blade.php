<section id='blog' class='container'>
    <div class='blog'>
        <div class='row'>
            <div class='col-md-8' id="content-article">  
...
<script>
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                if(result.daftar_artikel.length > 0)
                {
                    ...
                    html +=`
                    <center>`+generateWebPaging('webjava/article/', result.jumlah_artikel, result.item_per_page, result.active_page)+`</center>`;
                ...
                if(result.categories.length > 0){
                    ...
                    for(var i=0; i<result.categories.length;i++)
                    {
                        ...
                        categori += "<li><a href='#' data-href='webjava/article-categories/?str="+cat.kode_kategori+"'>"+cat.nama+" <span class='badge'>"+cat.jml+"</span></a></li>";
                    }
                }
                ...
                if(result.archive.length > 0){
                    ...
                    for(var i=0; i<result.archive.length;i++)
                    {
                        ...
                        archive += "<li><a href='#' data-href='webjava/article/1/"+arc.bulan+"/"+arc.tahun+"'><i class='fa fa-angle-double-right'></i> "+getNamaBulan(arc.bulan)+" "+arc.tahun+"<span class='pull-right'>("+arc.jml+")</span></a></li>";
                    }
                }
    ...
    $('.search_box').change(function(e){
        ...
        var url = "webjava/article-search/?str="+str;
        loadForm(url);
    });
