...
<!-- LIST DATA -->
<x-list-data judul="Data Justifikasi Pengajuan" tambah="true" :thead="array('No Bukti', 'No Dokumen', 'Regional', 'Waktu', 'Kegiatan', 'Posisi', 'Nilai', 'Aksi',)" :thwidth="array(10,25,5,10,20,5,10,25)" :thclass="array('','','','','','','','text-center')" />
<!-- END LIST DATA -->
...
<script type="text/javascript">
    ...
    function checkTableDokumen() {
        var nama = $('#input-dokumen').attr('data-table')
        var table = $('#input-dokumen tbody').children('tr')
        var kolom = ''
        var error = ''
        var baris = null
        var empty = false
        if(table.length === 0) {
            valid = false
            alert('Harap upload dokumen minimal 1 dokumen')
        } else {
            $('#input-dokumen tbody').children('tr').each(function() {
                baris = $(this).index() + 1
