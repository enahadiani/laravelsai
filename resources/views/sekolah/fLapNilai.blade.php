                                ...
                                <div class="px-4 pb-4 pt-2">
                                    <form id="form-filter">
                                        ...
                                        <div class="form-group row sai-rpt-filter-entry-row">
                                            <p class="kunci" hidden>kode_pp</p>
                                            <label for="kode_pp" class="col-md-2 col-sm-12 col-form-label">PP</label>
                                            <div class="col-md-2 col-sm-12" >
                                                <select name='kode_pp[]' class='form-control sai-rpt-filter-type selectize'><option value='=' selected>Sama dengan</option></select>
                                            </div>
                                            <div class="col-md-8 col-sm-12 sai-rpt-filter-from">
                                                <div class="input-group">
                                                    <input type="text" class="form-control border-right-0 " name="kode_pp[]" id="kode_pp-from" readonly>
                                            ...
                                            <div class="col-md-3 col-sm-12 sai-rpt-filter-to hidden" >
                                                <div class="input-group" >
                                                    <input type="text" class="form-control border-right-0 " name="kode_pp[]" id="kode_pp-to" readonly>
                                                    <div class="input-group-append border-left-0">
                                                    <a href="#" class="text-primary input-group-text search-item">ubah</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row sai-rpt-filter-entry-row">
                                            <p class="kunci" hidden>kode_ta</p>
                                            <label for="kode_ta" class="col-md-2 col-sm-12 col-form-label">Tahun Ajaran</label>
                                            <div class="col-md-2 col-sm-12" >
                                                <select name='kode_ta[]' class='form-control sai-rpt-filter-type selectize'><option value='=' selected>Sama dengan</option></select>
                                            </div>
                                            <div class="col-md-8 col-sm-12 sai-rpt-filter-from">
                                                <div class="input-group">
                                                    <input type="text" class="form-control border-right-0 " name="kode_ta[]" id="kode_ta-from" readonly>
                                                    <div class="input-group-append border-left-0">
                                                    <a href="#" class="text-primary input-group-text search-item">ubah</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3 col-sm-12 sai-rpt-filter-to hidden" >
                                                <div class="input-group" >
                                                    <input type="text" class="form-control border-right-0 " name="kode_ta[]" id="kode_ta-to" readonly>
                                                    <div class="input-group-append border-left-0">
                                                    <a href="#" class="text-primary input-group-text search-item">ubah</a>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        function showFilter(param,target1,type = null){
            ...
            switch(par){
                case 'kode_pp[]': 
                    header = ['Kode', 'Nama'];
                    var toUrl = "{{ url('sekolah-report/filter-pp') }}";
                    var columns = [
                        { data: 'kode_pp' },
                        { data: 'nama' }
                    ];
                ...
                case 'kode_ta[]': 
                    header = ['Kode', 'Nama'];
                    var toUrl = "{{ url('sekolah-report/filter-ta') }}";
                    var columns = [
                        { data: 'kode_ta' },
                        { data: 'nama' }
                    ];
                    header_pilih = ['Kode', 'Nama','Action'];
                    var judul = "Daftar Tahun Ajaran <span class='modal-subtitle'></span>";
                    var pilih = "tahun ajaran";
                    $target = $target;
                    $target2 = target2;
                    var display = "kode";
                    var field = eval("kode_ta");
                    var kunci = "kode_ta";
                    var orderby = [];
                    parameter = {
        ...
        $('#form-filter').submit(function(e){
            ...
            xurl = "{{ url('sekolah-auth/form/rptNeraca') }}";
        ...
        $('#saku-report #canvasPreview').on('click', '.neraca-lajur', function(e){
            ...
            `);
            xurl ="sekolah-auth/form/rptNrcLajur";
            $('#saku-report #canvasPreview').load(xurl);
            // drawLapReg(formData);
        });
        ...
        e.preventDefault();
            ...
            `);
            xurl ="sekolah-auth/form/rptBukuBesar";
            $('#saku-report #canvasPreview').load(xurl);
            // drawLapReg(formData);
        });
        ...
        $('#saku-report #canvasPreview').on('click', '.jurnal', function(e){
            ...
            `);
            xurl ="sekolah-auth/form/rptBuktiJurnal";
            $('#saku-report #canvasPreview').load(xurl);
            // drawLapReg(formData);
        });
        ...
        $('.navigation-lap').on('click', '#btn-back', function(e){
            ...
            if(aktif == "neraca-lajur"){
                xurl = "sekolah-auth/form/rptNeraca";
                $formData.delete('back');
