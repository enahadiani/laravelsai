...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Investasi"/>
...
<script>
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Investasi_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Investasi_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
    ...
    $('#modalEmail').on('submit','#formEmail',function(e){
        ...
        formData.append("text","Berikut ini kami lampiran Investasi:");
        formData.append("subject","Laporan Investasi");
        $.ajax({
            type: 'POST',
