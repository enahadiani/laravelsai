...
function getDataBox(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-inves-box') }}",
        data: param,
        dataType: 'json',
        async: true,
...
function getSerapAgg(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-inves-serap-agg') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
...
function getNilaiAset(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-inves-nilai-aset') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
...
function getAggLembaga(param) {
    $.ajax({
        type: 'GET',
        url: "{{ url('dash-tarbak-dash/data-inves-agg-lembaga') }}",
        data: param,
        dataType: 'json',
        async: true,
        success:function(result) {
