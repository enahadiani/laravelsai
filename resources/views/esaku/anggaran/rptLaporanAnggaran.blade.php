...
function drawRptPage(data,res,from,to) { 
    ...
    if(data.length > 0) {
        ...
        html += "<td class='isi-laporan' style='text-align: right;'>"+totalTW1+"</td>"
        html += "<td class='isi-laporan' style='text-align: right;'>"+totalTW2+"</td>"
        html += "<td class='isi-laporan' style='text-align: right;'>"+totalTW3+"</td>"
        html += "<td class='isi-laporan' style='text-align: right;'>"+totalTW4+"</td>"
        html += "<td class='isi-laporan' style='text-align: right;'>"+totalTotal+"</td>"
        html += "</tr>"
        html += "</tbody>"
        html += "</table>"
        html += "</div>"
