...
<script type="text/javascript">
    ...
    function getNota(no_bukti) {
        $.ajax({
            type:'GET',
            url:"{{url('esaku-trans/pembelian-baru-data-nota')}}",
            dataType: 'json',
    ...
    function getBarang() {
        $.ajax({
            type:'GET',
            url:"{{url('esaku-trans/pembelian-baru-barang')}}",
            dataType: 'json',
            async: false,
            success: function(result) {
                if(result.status) {
    ...
    $('#web-form-pos').submit(function(e){
        ...
        if(totrans <= 0){
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('esaku-trans/pembelian-baru')}}",
                dataType: 'json',
                data: formData,
                // async:false,
                contentType: false,
    ...
    $('#cetakBtn').click(function(){
        ...
        window.open("{{ url('esaku-trans/pembelian-baru-nota') }}/?no_bukti="+no_bukti); 
    });
