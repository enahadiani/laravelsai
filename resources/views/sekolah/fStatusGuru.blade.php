...
<div class="container-fluid mt-3" style="font-size:13px">
        <div class="row" id="saku-datatable">
            <div class="col-12">
                <div class="card" style="max-height:560px !important">
                    <div class="card-body">
                        <h4 class="card-title mb-4" style="font-size:16px"><i class='fas fa-cube'></i> Data Status Guru
    ...
    $('#saku-form').on('submit', '#form-tambah', function(e){
        ...
        if(parameter == "edit"){
            var url = "{{ url('/sekolah/postStatusGuru') }}/"+id;
            var pesan = "updated";
        }else{
            var url = "{{ url('/sekolah/postStatusGuru') }}";
            var pesan = "saved";
        }
    ...
    $('#saku-datatable').on('click','#btn-delete',function(e){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('sekolah/deleteStatusGuru') }}/"+kode +"/"+ kode_pp,
                    dataType: 'json',
                    async:false,
                    success:function(result){
                        if(result.data.status){
    ...
    $('#saku-datatable').on('click', '#btn-edit', function(){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('sekolah/getStatusGuru') }}/" + id + "/" + kode_pp,
            dataType: 'json',
            async:false,
