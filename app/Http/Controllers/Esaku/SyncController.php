...
class SyncController extends Controller
{
    ...
    public function getSyncPnjDetail(Request $request){
        try { 
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sync-pnj-detail',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function getSyncPmb(){
        try { 
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sync-pmb',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getSyncPmbDetail(Request $request){
        try { 
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sync-pmb-detail',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function syncPmb(Request $request)
    {
        ...
        try{
            ...
            $histori = "";
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/load-sync-pmb',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
            ...
            if($transm == "" && $transj == "" && $brgbeli == "" && $brgtrans == ""){
                ...
                $client2 = new Client();
                $response2 = $client2->request('POST',  config('api.url').'toko-trans/sync-pmb',[
                    'headers' => [
                        'Authorization' => 'Bearer '.$token,
                    ],
                    'form_params' => $fields
    ...
    public function getSyncReturBeli(){
        try { 
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sync-retur-beli',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
    ...
    public function getSyncReturBeliDetail(Request $request){
        try { 
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/sync-retur-beli-detail',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function syncReturBeli(Request $request)
    {
        ...
        try{
            ...
            $histori = "";
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'toko-trans/load-sync-retur-beli',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ]
