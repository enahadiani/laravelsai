...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Jurnal Aktiva Tetap"/>
...
<x-report-result judul="Laporan Jurnal Aktiva Tetap" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        ...
        url :["{{ url('esaku-report/filter-periode-perolehan') }}","{{ url('esaku-report/filter-bukti-jurnal-susut') }}"],
        parameter:[{},{}],
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptJurnalAktivaTetap') }}";
