...
<div id='dash_page_opex' class="mt-120">
    ...
    <div class="body-dash" style="position: relative;">
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_1">
                            <div id='opex_port_chart1'></div>
                        </div>
                        <div class="tab-pane" id="tab_2">
                            <div id='opex_port_table1'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_3">
                            <div id='opex_port_chart2'></div>
                        </div>
                        <div class="tab-pane" id="tab_4">
                            <div id='opex_port_table2'></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class='row mb-2'>
            <div class='col-md-12'>
                <div class="row px-2">
                    <div class="col-md-6">
                        <p><i class="fa fa-bar-chart"></i> By Portfolio (Trend Monthly Actual)</p>
                    </div>
                    <div class="col-md-6">
                        <ul class="nav nav-tabs col-12 justify-content-end" role="tablist">
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_5">
                            <div id='opex_port_chart3'></div>
                        </div>
                        <div class="tab-pane" id="tab_6">
                            <div id='opex_port_table3'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_7">
                            <div id='opex_port_chart4'></div>
                        </div>
                        <div class="tab-pane" id="tab_8">
                            <div id='opex_port_table4'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_9">
                            <div id='opex_port_chart5'></div>
                        </div>
                        <div class="tab-pane" id="tab_10">
                            <div id='opex_port_table5'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_11">
                            <div id='opex_port_chart6'></div>
                        </div>
                        <div class="tab-pane" id="tab_12">
                            <div id='opex_port_table6'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_13">
                            <div id='opex_port_chart7'></div>
                        </div>
                        <div class="tab-pane" id="tab_14">
                            <div id='opex_port_table7'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_15">
                            <div id='opex_port_chart8'></div>
                        </div>
                        <div class="tab-pane" id="tab_16">
                            <div id='opex_port_table8'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_17">
                            <div id='opex_port_chart9'></div>
                        </div>
                        <div class="tab-pane" id="tab_18">
                            <div id='opex_port_table9'></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-2">
                    <div class="tab-content tabcontent-border col-12">
                        <div class="tab-pane active" id="tab_19">
                            <div id='opex_port_chart10'></div>
                        </div>
                        <div class="tab-pane" id="tab_20">
                            <div id='opex_port_table10'></div>
                        </div>
                    </div>
                </div>
            </div>
...
var periode = "";
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.status){
                    ...
                    loadService('OPEX-Port','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: "All",field:"portofolio",modul:"OPEX"});
                    loadService('OPEX-Prod','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: "All",field:"produk",modul:"OPEX"});
                ...
                if(data.status){
                    switch(index){
                        case 'OPEX-Port':
                            ...
                            drawTable('#opex_port_table1', thead1, data.summary, ["portofolio","n2","n1","persen1"], "class='table table-striped table-bordered'", {"n2":"sepNum2Kanan","n1":"sepNum2Kanan","persen1":"sepNum2Kanan%"});
                            drawTable('#opex_port_table2', thead1, data.summary, ["portofolio","n3","n1","persen2"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan","n1":"sepNum2Kanan","persen2":"sepNum2Kanan%"});
                            drawTable('#opex_port_table3', thead2, data.trend, ["portofolio","n1","n2","n3","n4","n5","n6","n7","n8","n9","n10","n11","n12"], "class='table table-striped table-bordered'", {"n1":"sepNum2Kanan","n2":"sepNum2Kanan","n3":"sepNum2Kanan","n4":"sepNum2Kanan","n5":"sepNum2Kanan","n6":"sepNum2Kanan","n7":"sepNum2Kanan","n8":"sepNum2Kanan","n9":"sepNum2Kanan","n10":"sepNum2Kanan","n11":"sepNum2Kanan","n12":"sepNum2Kanan"});
                            drawTable('#opex_port_table4', thead3, data.summary, ["portofolio","n1"], "class='table table-striped table-bordered'", {"n1":"sepNum2Kanan"});
                            drawTable('#opex_port_table5', thead4, data.summary, ["portofolio","n3"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan"});

                            drawChart('column', 'opex_port_chart1', data.series, data.categories);
                            drawChart('column', 'opex_port_chart2', data.series2, data.categories);
                            drawChart('spline', 'opex_port_chart3', data.series3, ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Okt","Nop","Des"]);
                            drawChart('pie', 'opex_port_chart4', [data.series4],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                            ...
                            drawChart('pie', 'opex_port_chart5', [data.series5],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
                        ...
                        case 'OPEX-Prod':
                            ...
                            drawTable('#opex_port_table6', thead1, data.summary, ["produk","n2","n1"], "class='table table-striped table-bordered'", {"n2":"sepNum2Kanan","n1":"sepNum2Kanan"});
                            drawTable('#opex_port_table7', thead1, data.summary, ["produk","n3","n1"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan","n1":"sepNum2Kanan"});
                            drawTable('#opex_port_table8', thead2, data.trend, ["produk","n1","n2","n3","n4","n5","n6","n7","n8","n9","n10","n11","n12"], "class='table table-striped table-bordered'", {"n1":"sepNum2Kanan","n2":"sepNum2Kanan","n3":"sepNum2Kanan","n4":"sepNum2Kanan","n5":"sepNum2Kanan","n6":"sepNum2Kanan","n7":"sepNum2Kanan","n8":"sepNum2Kanan","n9":"sepNum2Kanan","n10":"sepNum2Kanan","n11":"sepNum2Kanan","n12":"sepNum2Kanan"});
                            drawTable('#opex_port_table9', thead3, data.summary, ["produk","n1"], "class='table table-striped table-bordered'", {"n1":"sepNum2Kanan"});
                            drawTable('#opex_port_table10', thead4, data.summary, ["produk","n3"], "class='table table-striped table-bordered'", {"n3":"sepNum2Kanan"});

                            drawChart('column', 'opex_port_chart6', data.series, data.categories);
                            drawChart('column', 'opex_port_chart7', data.series2, data.categories);
                            drawChart('column', 'opex_port_chart8', data.series3, ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Okt","Nop","Des"]);
                            drawChart('pie', 'opex_port_chart9', [data.series4],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
                            ...
                            drawChart('pie', 'opex_port_chart10', [data.series5],'',false,{
                                pie: {
                                    dataLabels: {
                                        enabled: true,
                                        format: '<strong>{point.name}</strong><br>{point.percentage:.1f}%'
    ...
    $('#form-filter').submit(function(e){
        ...
        loadService('OPEX-Port','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: dept,field:"portofolio",modul:"OPEX"});
        loadService('OPEX-Prod','GET',"{{ url('siaga-dash/dataof-modul') }}",{periode : periode,dept: dept,field:"produk",modul:"OPEX"});
